...
//=========  (Fri Sep 22 05:45:53 2017) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,3.406776e-05);
   hEff2->SetBinContent(2,0.009082997);
   hEff2->SetBinContent(3,0.04113186);
   hEff2->SetBinContent(4,0.09762678);
   hEff2->SetBinContent(5,0.1942806);
   hEff2->SetBinError(1,3.288324e-05);
   hEff2->SetBinError(2,0.0007119483);
   hEff2->SetBinError(3,0.002534867);
   hEff2->SetBinError(4,0.005073108);
   hEff2->SetBinError(5,0.08846911);
   hEff2->SetEntries(669.3379);
   hEff2->SetStats(0);
