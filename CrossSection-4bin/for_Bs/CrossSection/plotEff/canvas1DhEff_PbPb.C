...
//=========  (Sat Sep 23 08:07:58 2017) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.007442908);
   hEff2->SetBinContent(1,0.1040214);
   hEff2->SetBinContent(2,0.1901976);
   hEff2->SetBinError(0,0.00033939);
   hEff2->SetBinError(1,0.003181982);
   hEff2->SetBinError(2,0.102263);
   hEff2->SetEntries(1068.686);
   hEff2->SetStats(0);
