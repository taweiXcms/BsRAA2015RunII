...
void fitNP(int usePbPb=0, 
TString inputdata="/afs/cern.ch/work/c/cdozen/UP_BFINDER/CMSSW_7_5_8_patch3/src/Bfinder/Bfinder/Bntuple/looper/NPfiles/loop_BJpsiMM_pp_NP.root" , 
...
//ppNp/
TString cut="TMath::Abs(By)<2.4&&TMath::Abs(Bmumumass-3.096916)<0.15&&mass>5&&Bmass<6&&Btrk1Pt>0.7&&Btrk2Pt>0.7&&Bchi2cl>1.32e-02&&(Bd0/Bd0Err)>2.&&cos(Bdtheta)>2.60e-01&&Bmu1pt>1.5&&Bmu2pt>1.5&&Blxy>0.025&&abs(Btktkmass-1.019455)<1.55e-02",
  
//PbPb NP//TString cut="TMath::Abs(By)<2.4&&TMath::Abs(Bmumumass-3.096916)<0.15&&Bmass>5&&Bmass<6&&Btrk1Pt>0.7&&Btrk2Pt>0.7&&Bchi2cl>1.32e-02&&(Bd0/Bd0Err)>2.&&cos(Bdtheta)>-2.60e-01&&Bmu1pt>1.5&&Bmu2pt>1.5&&Blxy>0.025", 
TString cutmcgen="TMath::Abs(Gy)<2.4&&GpdgId==531&&Bgen!=23333", 
int isMC=0, 
Double_t luminosity=1., 
int doweight=0, 
TString collsyst="pp", 
TString outputfile="ROOTfiles/mytest.root", 
Float_t centmin=10., 
Float_t centmax=1000.)
{
