...
//=========  (Fri Sep 22 05:06:12 2017) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.004184245);
   hEff2->SetBinContent(2,0.05926291);
   hEff2->SetBinContent(3,0.1462618);
   hEff2->SetBinContent(4,0.2326192);
   hEff2->SetBinContent(5,0.229469);
   hEff2->SetBinError(1,0.0003031565);
   hEff2->SetBinError(2,0.002274979);
   hEff2->SetBinError(3,0.006756925);
   hEff2->SetBinError(4,0.01102345);
   hEff2->SetBinError(5,0.1166233);
   hEff2->SetEntries(1134.623);
   hEff2->SetStats(0);
