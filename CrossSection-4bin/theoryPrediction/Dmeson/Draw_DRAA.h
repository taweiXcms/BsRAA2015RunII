...
c->SetHighLightColor(2);
   ...
   grae->SetTitle("Graph");
//   grae->SetFillColor(5);
   grae->SetFillColor(kGreen-9);
   grae->SetFillColorAlpha(kGreen-9, 0.5);
...
//   grae->SetFillStyle(3001);
   ...
   hNuclearModification2->SetMarkerColor(kGreen+3);
   ...
   hNuclearModification3->SetMarkerColor(kGreen+3);
