...
//=========  (Fri Sep 22 05:06:15 2017) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   Graph_gaeSigmaBplus3001->SetMinimum(2557.867);
   Graph_gaeSigmaBplus3001->SetMaximum(1199661);
   ...
   hPtSigma2->SetBinContent(1,619133.9);
   hPtSigma2->SetBinContent(2,150095.8);
   hPtSigma2->SetBinContent(3,25996.09);
   hPtSigma2->SetBinContent(4,3044.375);
   hPtSigma2->SetBinError(1,173787.2);
   hPtSigma2->SetBinError(2,20831.79);
   hPtSigma2->SetBinError(3,5440.826);
   hPtSigma2->SetBinError(4,520.0389);
   hPtSigma2->SetEntries(20.77999);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(2739.937);
   Graph_gaeCrossSyst3002->SetMaximum(680742.9);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.3856536);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.091297);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.5294907);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9208222);
