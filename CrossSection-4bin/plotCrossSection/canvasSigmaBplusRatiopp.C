...
//=========  (Thu Nov 30 15:28:38 2017) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,224632.1);
   hPtSigma2->SetBinContent(2,43034.49);
   hPtSigma2->SetBinContent(3,13821.6);
   hPtSigma2->SetBinContent(4,1047.144);
   hPtSigma2->SetBinError(1,28211.73);
   hPtSigma2->SetBinError(2,7047.154);
   hPtSigma2->SetBinError(3,2152.972);
   hPtSigma2->SetBinError(4,384.3018);
   hPtSigma2->SetBinError(5,nan);
   hPtSigma2->SetEntries(93.87487);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(942.4297);
   Graph_gaeCrossSyst3002->SetMaximum(246990.6);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.4040255);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.595527);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7417139);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.382705);
