...
//=========  (Fri Sep 22 05:45:56 2017) by ROOT version6.02/13
   TCanvas *cSigma = new TCanvas("cSigma", "",0,0,600,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cSigma->SetHighLightColor(2);
   cSigma->Range(-11.78841,1.47101,69.42065,7.348675);
   ...
   TH2F *hemptySigma1 = new TH2F("hemptySigma1","",50,0,65,10,100,1e+07);
   ...
   hPtSigma2->SetBinContent(1,2.478338e+07);
   hPtSigma2->SetBinContent(2,105214.7);
   hPtSigma2->SetBinContent(3,33161.09);
   hPtSigma2->SetBinContent(4,1251.496);
   hPtSigma2->SetBinError(1,2.804637e+07);
   hPtSigma2->SetBinError(2,100987);
   hPtSigma2->SetBinError(3,19622.94);
   hPtSigma2->SetBinError(4,884.6946);
   hPtSigma2->SetEntries(0.7896629);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(1126.347);
   Graph_gaeCrossSyst3001->SetMaximum(2.726159e+07);
