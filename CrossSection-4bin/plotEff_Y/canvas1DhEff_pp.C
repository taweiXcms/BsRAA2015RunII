...
//=========  (Fri Dec  1 19:34:30 2017) by ROOT version6.02/13
   TCanvas *canvas1D = new TCanvas("canvas1D", "",0,0,600,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   canvas1D->SetHighLightColor(2);
   canvas1D->Range(-6.55,-0.07500001,8.95,0.675);
   ...
   TH2F *hemptyEff1 = new TH2F("hemptyEff1","",50,-5,7.4,10,0,0.6);
   ...
   hEff2->SetBinContent(1,0.0774298);
   hEff2->SetBinContent(2,0.08263639);
   hEff2->SetBinContent(3,0.08780648);
   hEff2->SetBinContent(4,0.04702682);
   hEff2->SetBinError(1,0.000707217);
   hEff2->SetBinError(2,0.0007514252);
   hEff2->SetBinError(3,0.000824113);
   hEff2->SetBinError(4,0.0005191514);
   hEff2->SetEntries(43191.82);
   hEff2->SetStats(0);
   ...
   hEff2->Draw("same");
   TLatex *   tex = new TLatex(0.5,0.75,"10. < p_{T} < 50.");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
