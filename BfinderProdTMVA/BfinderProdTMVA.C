...
//string ifname = "/data/HeavyFlavourRun2/BfinderRun2/MC_official/crab_BfinderMC_pp_BJpsiMM_5p02TeV_TuneCUETP8M1_ext_20171128_bPt0jpsiPt0tkPt0p0_Bs/171208_203104/0000/finder_pp_*.root";
//string ofname = "0000.root";
//string ifname = "/data/HeavyFlavourRun2/BfinderRun2/MC_official/crab_BfinderMC_pp_BJpsiMM_5p02TeV_TuneCUETP8M1_ext_20171128_bPt0jpsiPt0tkPt0p0_Bs/171208_203104/0001/finder_pp_*.root";
//string ofname = "0001.root";
//string ifname = "../BfinderMC_pp_BJpsiMM_5p02TeV_TuneCUETP8M1_20171128_bPt0jpsiPt0tkPt0p0_Bs.root";
//string ofname = "../BfinderMC_pp_BJpsiMM_5p02TeV_TuneCUETP8M1_20171128_bPt0jpsiPt0tkPt0p0_Bs_BDTStage1_pt15to50.root";
//TString weightfile = "TMVA_BDT_pp_15_50_varStage1.weights.xml";

//string ifname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_00_03_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs.root"; 
//string ifname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_03_06_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs.root";
//string ifname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_06_09_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs.root";
//string ifname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_09_12_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs.root";
//string ifname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_12_15_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs.root";
//string ifname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_15_30_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs.root";
//string ifname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_30_inf_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs.root";
//string ofname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_00_03_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs_BDTStage1_pt15to50.root"; 
//string ofname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_03_06_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs_BDTStage1_pt15to50.root";
//string ofname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_06_09_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs_BDTStage1_pt15to50.root";
//string ofname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_09_12_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs_BDTStage1_pt15to50.root";
//string ofname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_12_15_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs_BDTStage1_pt15to50.root";
//string ofname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_15_30_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs_BDTStage1_pt15to50.root";
//string ofname = "../BfinderMC_PbPb_Pythia8_BJpsiMM_ptJpsi_30_inf_Hydjet_MB_20171128_bPt0jpsiPt0tkPt0p0_Bs_BDTStage1_pt15to50.root";
...
void BfinderProdTMVA(){
	TChain* root = 			new TChain("Bfinder/root");
	TChain* hltanalysis = 	new TChain("hltanalysis/HltTree");
	TChain* hiEvtAnalyzer = new TChain("hiEvtAnalyzer/HiTree");
	TChain* skimanalysis = 	new TChain("skimanalysis/HltTree");
	root->Add(ifname.c_str());
	hltanalysis->Add(ifname.c_str());
	hiEvtAnalyzer->Add(ifname.c_str());
	skimanalysis->Add(ifname.c_str());
	...
	for(Int_t i=startEntries;i<endEntries;i++){
		if(i%10000==0) cout<<i<<"/"<<endEntries<<endl;
		root->GetEntry(i);	
		hltanalysis->GetEntry(i);	
		hiEvtAnalyzer->GetEntry(i);	
		skimanalysis->GetEntry(i);	
		_size = BInfo->size;
