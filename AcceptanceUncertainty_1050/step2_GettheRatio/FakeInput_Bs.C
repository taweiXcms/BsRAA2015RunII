...
// call the root files including raw yield from data and MC (for pt and y binning)
    TFile *foutDataPt   = new TFile("../Inputfileforreweighting/hPtSpectrumBplusPP_1050.root","read");
    TFile *foutDatay    = new TFile("../Inputfileforreweighting/hPtSpectrumBplusPP_Y.root","read");
    TFile *foutMCPt     = new TFile("../Inputfileforreweighting/MCstudiesPP_1050.root","read");
    TFile *foutMCy      = new TFile("../Inputfileforreweighting/MCstudiesPP_Y.root","read");
	if(ispp==0){
	    foutDataPt   = new TFile("../Inputfileforreweighting/hPtSpectrumBplusPP_1050.root","read");
	    foutDatay    = new TFile("../Inputfileforreweighting/hPtSpectrumBplusPP_Y.root","read");
	    foutMCPt     = new TFile("../Inputfileforreweighting/MCstudiesPP_1050.root","read");
