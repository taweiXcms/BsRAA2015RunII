...
//=========  (Sun Apr 22 18:48:35 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(4.639081e-07);
   Graph_gNuclearModification3002->SetMaximum(1.583454e-06);
