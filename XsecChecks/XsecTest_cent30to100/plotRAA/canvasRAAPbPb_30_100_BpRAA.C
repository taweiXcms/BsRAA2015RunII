void canvasRAAPbPb_30_100_BpRAA()
{
//=========Macro generated from canvas: canvasRAA/canvasRAA
//=========  (Sun Apr 22 18:48:32 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(4.191219e-07);
   Graph_gNuclearModification3002->SetMaximum(1.629112e-06);
   ...
   hNuclearModification4->SetBinContent(1,1.150383e-06);
   hNuclearModification4->SetBinContent(2,6.413761e-07);
   hNuclearModification4->SetBinError(1,1.419462e-07);
   hNuclearModification4->SetBinError(2,0.1875368);
   hNuclearModification4->SetEntries(9.12823e-11);
   ...
   hNuclearModification5->SetBinContent(1,1.150383e-06);
   hNuclearModification5->SetBinContent(2,6.413761e-07);
   hNuclearModification5->SetBinError(1,1.419462e-07);
   hNuclearModification5->SetBinError(2,0.1875368);
   hNuclearModification5->SetEntries(9.12823e-11);
