...
//=========  (Sun Apr 22 18:48:27 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.003890497);
   hEff2->SetBinContent(2,0.06378643);
   hEff2->SetBinError(1,0.0001656181);
   hEff2->SetBinError(2,0.001148426);
   hEff2->SetEntries(3402.013);
   hEff2->SetStats(0);
   ...
   hEff2->Draw("same");
   TLatex *   tex = new TLatex(0.5,0.815,"Centrality 30 - 100%");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
