void canvasSigmaBplusRatioPbPb_30_100()
{
//=========Macro generated from canvas: cSigma/
//=========  (Sun Apr 22 18:48:29 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,0.3640602);
   hPtSigma2->SetBinContent(2,0.005335253);
   hPtSigma2->SetBinError(1,0.01551046);
   hPtSigma2->SetBinError(2,1560.015);
   hPtSigma2->SetEntries(5.606938e-08);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(0.004018411);
   Graph_gaeCrossSyst3001->SetMaximum(0.5058903);
