...
//=========  (Sun Apr 22 18:48:21 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.002603622);
   hEff2->SetBinContent(2,0.04733291);
   hEff2->SetBinError(1,0.0001844174);
   hEff2->SetBinError(2,0.001464633);
   hEff2->SetEntries(1144.321);
   hEff2->SetStats(0);
   ...
   hEff2->Draw("same");
   TLatex *   tex = new TLatex(0.5,0.815,"Centrality 0 - 10%");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
