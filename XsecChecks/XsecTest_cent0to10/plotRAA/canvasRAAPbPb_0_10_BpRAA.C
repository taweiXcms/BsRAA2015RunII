...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.6475326);
   Graph_gNuclearModification3002->SetMaximum(3.216834);
   ...
   hNuclearModification4->SetBinContent(1,2.260245);
   hNuclearModification4->SetBinContent(2,1.062855);
   hNuclearModification4->SetBinError(1,1.125941);
   hNuclearModification4->SetBinError(2,0.5289131);
   hNuclearModification4->SetEntries(7.13606);
   ...
   hNuclearModification5->SetBinContent(1,2.260245);
   hNuclearModification5->SetBinContent(2,1.062855);
   hNuclearModification5->SetBinError(1,1.125941);
   hNuclearModification5->SetBinError(2,0.5289131);
   hNuclearModification5->SetEntries(7.13606);
