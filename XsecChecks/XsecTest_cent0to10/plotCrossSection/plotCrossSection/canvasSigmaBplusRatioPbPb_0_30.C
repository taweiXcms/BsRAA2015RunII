...
//=========  (Fri Apr 20 19:48:03 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,525811.9);
   hPtSigma2->SetBinContent(2,8997.557);
   hPtSigma2->SetBinError(1,213336.3);
   hPtSigma2->SetBinError(2,2907.509);
   hPtSigma2->SetEntries(6.283304);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(6776.788);
   Graph_gaeCrossSyst3001->SetMaximum(730548.8);
