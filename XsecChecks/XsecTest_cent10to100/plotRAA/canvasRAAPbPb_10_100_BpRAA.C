void canvasRAAPbPb_10_100_BpRAA()
{
//=========Macro generated from canvas: canvasRAA/canvasRAA
//=========  (Sun Apr 22 18:48:25 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.5002243);
   Graph_gNuclearModification3002->SetMaximum(1.542261);
   ...
   hNuclearModification4->SetBinContent(1,1.095544);
   hNuclearModification4->SetBinContent(2,0.7241533);
   hNuclearModification4->SetBinError(1,0.5861586);
   hNuclearModification4->SetBinError(2,0.3260311);
   hNuclearModification4->SetEntries(7.360429);
   ...
   hNuclearModification5->SetBinContent(1,1.095544);
   hNuclearModification5->SetBinContent(2,0.7241533);
   hNuclearModification5->SetBinError(1,0.5861586);
   hNuclearModification5->SetBinError(2,0.3260311);
   hNuclearModification5->SetEntries(7.360429);
