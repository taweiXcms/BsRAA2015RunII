void canvasSigmaBplusRatioPbPb_10_100()
{
...
//=========  (Sun Apr 22 18:48:21 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,346705.1);
   hPtSigma2->SetBinContent(2,6023.832);
   hPtSigma2->SetBinError(1,181103.8);
   hPtSigma2->SetBinError(2,2603.288);
   hPtSigma2->SetEntries(3.792602);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(4537.035);
   Graph_gaeCrossSyst3001->SetMaximum(481695.1);
