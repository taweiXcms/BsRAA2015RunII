...
//=========  (Sun Apr 22 18:48:19 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.003323557);
   hEff2->SetBinContent(2,0.05623218);
   hEff2->SetBinError(1,0.0001492541);
   hEff2->SetBinError(2,0.001114617);
   hEff2->SetEntries(2804.641);
   hEff2->SetStats(0);
   ...
   hEff2->Draw("same");
   TLatex *   tex = new TLatex(0.5,0.815,"Centrality 10 - 100%");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
