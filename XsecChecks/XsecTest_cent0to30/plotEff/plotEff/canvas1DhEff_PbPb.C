...
//=========  (Sun Apr 22 18:48:21 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.002793191);
   hEff2->SetBinContent(2,0.04965578);
   hEff2->SetBinError(1,0.0001444085);
   hEff2->SetBinError(2,0.001122027);
   hEff2->SetEntries(2149.474);
   hEff2->SetStats(0);
