...
//=========  (Fri Apr 20 19:53:38 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.5489466);
   Graph_gNuclearModification3002->SetMaximum(1.792777);
   ...
   hNuclearModification4->SetBinContent(1,1.271457);
   hNuclearModification4->SetBinContent(2,0.8049966);
   hNuclearModification4->SetBinError(1,0.5306985);
   hNuclearModification4->SetBinError(2,0.2835694);
   hNuclearModification4->SetEntries(11.90893);
   ...
   hNuclearModification5->SetBinContent(1,1.271457);
   hNuclearModification5->SetBinContent(2,0.8049966);
   hNuclearModification5->SetBinError(1,0.5306985);
   hNuclearModification5->SetBinError(2,0.2835694);
   hNuclearModification5->SetEntries(11.90893);
