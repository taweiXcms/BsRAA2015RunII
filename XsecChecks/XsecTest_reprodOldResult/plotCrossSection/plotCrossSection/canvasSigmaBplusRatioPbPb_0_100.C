...
//=========  (Tue May  8 19:34:57 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,4731.916);
   hPtSigma2->SetBinError(1,1909.772);
   hPtSigma2->SetEntries(6.139187);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(3230.755);
   Graph_gaeCrossSyst3001->SetMaximum(6233.078);
