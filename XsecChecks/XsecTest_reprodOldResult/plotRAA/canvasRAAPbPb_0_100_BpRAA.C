...
//=========  (Tue May  8 19:37:04 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.4404222);
   Graph_gNuclearModification3002->SetMaximum(0.6993533);
   ...
   hNuclearModification4->SetBinContent(1,0.5698877);
   hNuclearModification4->SetBinError(1,0.2416859);
   hNuclearModification4->SetEntries(5.560016);
   ...
   hNuclearModification5->SetBinContent(1,0.5698877);
   hNuclearModification5->SetBinError(1,0.2416859);
   hNuclearModification5->SetEntries(5.560016);
