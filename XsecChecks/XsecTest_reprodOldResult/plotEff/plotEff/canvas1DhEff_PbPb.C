...
//=========  (Tue May  8 19:28:16 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0008891602);
   hEff2->SetBinContent(1,0.04811457);
   hEff2->SetBinContent(2,0.1440664);
   hEff2->SetBinError(0,5.474666e-05);
   hEff2->SetBinError(1,0.001039098);
   hEff2->SetBinError(2,0.004740167);
   hEff2->SetEntries(2144.076);
   hEff2->SetStats(0);
