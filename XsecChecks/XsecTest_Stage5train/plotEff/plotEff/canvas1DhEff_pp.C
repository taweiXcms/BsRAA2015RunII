...
//=========  (Fri Apr 20 21:47:02 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.02222024);
   hEff2->SetBinContent(2,0.1549469);
   hEff2->SetBinError(1,0.000168701);
   hEff2->SetBinError(2,0.0007372683);
   hEff2->SetEntries(54872.11);
   hEff2->SetStats(0);
