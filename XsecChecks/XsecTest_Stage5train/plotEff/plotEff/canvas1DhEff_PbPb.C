...
//=========  (Fri Apr 20 21:52:24 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.00308437);
   hEff2->SetBinContent(2,0.0516624);
   hEff2->SetBinError(1,0.0001497281);
   hEff2->SetBinError(2,0.001082057);
   hEff2->SetEntries(2511.77);
   hEff2->SetStats(0);
