...
//=========  (Fri Apr 20 22:16:31 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.4885218);
   Graph_gNuclearModification3002->SetMaximum(1.699306);
   ...
   hNuclearModification4->SetBinContent(1,1.233951);
   hNuclearModification4->SetBinContent(2,0.6784597);
   hNuclearModification4->SetBinError(1,0.5171636);
   hNuclearModification4->SetBinError(2,0.2444573);
   hNuclearModification4->SetEntries(11.17701);
   ...
   hNuclearModification5->SetBinContent(1,1.233951);
   hNuclearModification5->SetBinContent(2,0.6784597);
   hNuclearModification5->SetBinError(1,0.5171636);
   hNuclearModification5->SetBinError(2,0.2444573);
   hNuclearModification5->SetEntries(11.17701);
