...
//=========  (Fri Apr 20 22:16:25 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,429203.5);
   hPtSigma2->SetBinContent(2,6438.715);
   hPtSigma2->SetBinError(1,173504.4);
   hPtSigma2->SetBinError(2,2173.203);
   hPtSigma2->SetEntries(6.303344);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(4849.517);
   Graph_gaeCrossSyst3001->SetMaximum(596399.5);
