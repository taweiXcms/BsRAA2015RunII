...
//=========  (Fri Apr 20 22:16:07 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,347828.8);
   hPtSigma2->SetBinContent(2,9490.195);
   hPtSigma2->SetBinError(1,38480.38);
   hPtSigma2->SetBinError(2,1196.828);
   hPtSigma2->SetEntries(86.14169);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(7720.698);
   Graph_gaeCrossSyst3001->SetMaximum(456356.9);
...
tex->SetNDC();
   ...
   Graph_Graph_gaeCrossSyst30013002->SetMinimum(4849.517);
   Graph_Graph_gaeCrossSyst30013002->SetMaximum(596399.5);
   ...
   hPtSigma3->SetBinContent(1,429203.5);
   hPtSigma3->SetBinContent(2,6438.715);
   hPtSigma3->SetBinError(1,173504.4);
   hPtSigma3->SetBinError(2,2173.203);
   hPtSigma3->SetEntries(6.303344);
