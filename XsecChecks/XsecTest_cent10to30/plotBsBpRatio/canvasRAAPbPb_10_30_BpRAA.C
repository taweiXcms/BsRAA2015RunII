void canvasRAAPbPb_10_30_BpRAA()
{
//=========Macro generated from canvas: canvasRAA/canvasRAA
//=========  (Sun Apr 22 18:49:07 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.8227964);
   Graph_gNuclearModification3002->SetMaximum(1.726256);
   ...
   hNuclearModification4->SetBinContent(1,1.274526);
   hNuclearModification4->SetBinContent(2,1.049855);
   hNuclearModification4->SetBinError(1,0.7527936);
   hNuclearModification4->SetBinError(2,0.4727996);
   hNuclearModification4->SetEntries(6.836862);
   ...
   hNuclearModification5->SetBinContent(1,1.274526);
   hNuclearModification5->SetBinContent(2,1.049855);
   hNuclearModification5->SetBinError(1,0.7527936);
   hNuclearModification5->SetBinError(2,0.4727996);
   hNuclearModification5->SetEntries(6.836862);
