void canvasSigmaBplusRatioPbPb_10_30()
{
//=========Macro generated from canvas: cSigma/
//=========  (Sun Apr 22 18:49:01 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,403347.5);
   hPtSigma2->SetBinContent(2,8733.161);
   hPtSigma2->SetBinError(1,233611.8);
   hPtSigma2->SetBinError(2,3775.29);
   hPtSigma2->SetEntries(3.110723);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(6577.65);
   Graph_gaeCrossSyst3001->SetMaximum(560246.8);
