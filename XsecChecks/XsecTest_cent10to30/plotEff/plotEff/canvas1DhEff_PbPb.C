...
//=========  (Sun Apr 22 18:48:59 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.003235657);
   hEff2->SetBinContent(2,0.05533518);
   hEff2->SetBinError(1,0.000168963);
   hEff2->SetBinError(2,0.001285244);
   hEff2->SetEntries(2041.505);
   hEff2->SetStats(0);
   ...
   hEff2->Draw("same");
   TLatex *   tex = new TLatex(0.5,0.815,"Centrality 10 - 30%");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
