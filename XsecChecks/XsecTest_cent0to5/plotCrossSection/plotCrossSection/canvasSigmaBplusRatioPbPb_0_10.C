void canvasSigmaBplusRatioPbPb_0_10()
{
//=========Macro generated from canvas: cSigma/
//=========  (Fri Apr 20 21:48:44 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,715296.7);
   hPtSigma2->SetBinContent(2,8841.302);
   hPtSigma2->SetBinError(1,346563.4);
   hPtSigma2->SetBinError(2,4255.825);
   hPtSigma2->SetEntries(4.365276);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(6659.1);
   Graph_gaeCrossSyst3001->SetMaximum(994098.3);
