void canvasSigmaBplusRatioPbPb_0_5()
{
//=========Macro generated from canvas: cSigma/
//=========  (Sun Apr 22 18:48:12 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,718629.6);
   hPtSigma2->SetBinContent(2,5615.845);
   hPtSigma2->SetBinError(1,374154.8);
   hPtSigma2->SetBinError(2,3458.455);
   hPtSigma2->SetEntries(3.746553);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(4229.748);
   Graph_gaeCrossSyst3001->SetMaximum(999003.6);
