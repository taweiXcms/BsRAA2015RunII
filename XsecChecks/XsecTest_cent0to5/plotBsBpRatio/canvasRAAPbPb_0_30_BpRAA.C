void canvasRAAPbPb_0_30_BpRAA()
{
//=========Macro generated from canvas: canvasRAA/canvasRAA
//=========  (Fri Apr 20 19:48:08 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.8184329);
   Graph_gNuclearModification3002->SetMaximum(2.273489);
   ...
   hNuclearModification4->SetBinContent(1,1.661498);
   hNuclearModification4->SetBinContent(2,1.081639);
   hNuclearModification4->SetBinError(1,0.7010354);
   hNuclearModification4->SetBinError(2,0.3752483);
   hNuclearModification4->SetEntries(11.9014);
   ...
   hNuclearModification5->SetBinContent(1,1.661498);
   hNuclearModification5->SetBinContent(2,1.081639);
   hNuclearModification5->SetBinError(1,0.7010354);
   hNuclearModification5->SetBinError(2,0.3752483);
   hNuclearModification5->SetEntries(11.9014);
