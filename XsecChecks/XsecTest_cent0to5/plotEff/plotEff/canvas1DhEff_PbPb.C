...
//=========  (Sun Apr 22 18:48:09 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.002233492);
   hEff2->SetBinContent(2,0.0442531);
   hEff2->SetBinError(1,0.0002189646);
   hEff2->SetBinError(2,0.001824334);
   hEff2->SetEntries(640.0808);
   hEff2->SetStats(0);
   ...
   hEff2->Draw("same");
   TLatex *   tex = new TLatex(0.5,0.815,"Centrality 0 - 5%");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
