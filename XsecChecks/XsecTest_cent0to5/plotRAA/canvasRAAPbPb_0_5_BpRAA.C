void canvasRAAPbPb_0_5_BpRAA()
{
//=========Macro generated from canvas: canvasRAA/canvasRAA
//=========  (Sun Apr 22 18:48:15 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.3003581);
   Graph_gNuclearModification3002->SetMaximum(3.263658);
   ...
   hNuclearModification4->SetBinContent(1,2.270777);
   hNuclearModification4->SetBinContent(2,0.6751074);
   hNuclearModification4->SetBinError(1,1.211171);
   hNuclearModification4->SetBinError(2,0.4244018);
   hNuclearModification4->SetEntries(5.268947);
   ...
   hNuclearModification5->SetBinContent(1,2.270777);
   hNuclearModification5->SetBinContent(2,0.6751074);
   hNuclearModification5->SetBinError(1,1.211171);
   hNuclearModification5->SetBinError(2,0.4244018);
   hNuclearModification5->SetEntries(5.268947);
