void canvasRAAPbPb_5_100_BpRAA()
{
//=========Macro generated from canvas: canvasRAA/canvasRAA
//=========  (Sun Apr 22 18:48:21 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.6097975);
   Graph_gNuclearModification3002->SetMaximum(1.279376);
   ...
   hNuclearModification4->SetBinContent(1,0.9445869);
   hNuclearModification4->SetBinContent(2,0.8087037);
   hNuclearModification4->SetBinError(1,0.5110199);
   hNuclearModification4->SetBinError(2,0.323129);
   hNuclearModification4->SetEntries(8.409239);
   ...
   hNuclearModification5->SetBinContent(1,0.9445869);
   hNuclearModification5->SetBinContent(2,0.8087037);
   hNuclearModification5->SetBinError(1,0.5110199);
   hNuclearModification5->SetBinError(2,0.323129);
   hNuclearModification5->SetEntries(8.409239);
