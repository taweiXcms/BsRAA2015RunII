void canvasSigmaBplusRatioPbPb_5_100()
{
...
//=========  (Sun Apr 22 18:48:15 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,298932.1);
   hPtSigma2->SetBinContent(2,6727.16);
   hPtSigma2->SetBinError(1,157973.4);
   hPtSigma2->SetBinError(2,2550.262);
   hPtSigma2->SetEntries(3.742778);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(5066.768);
   Graph_gaeCrossSyst3001->SetMaximum(415193.3);
