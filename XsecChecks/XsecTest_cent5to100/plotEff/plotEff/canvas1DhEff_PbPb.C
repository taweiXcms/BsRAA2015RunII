...
//=========  (Sun Apr 22 18:48:12 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.003335672);
   hEff2->SetBinContent(2,0.05435829);
   hEff2->SetBinError(1,0.0001646901);
   hEff2->SetBinError(2,0.001144202);
   hEff2->SetEntries(2490.864);
   hEff2->SetStats(0);
   ...
   hEff2->Draw("same");
   TLatex *   tex = new TLatex(0.5,0.815,"Centrality 5 - 100%");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
