...
//=========  (Fri Apr 20 19:50:42 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3002->SetMinimum(0.6442501);
   Graph_gNuclearModification3002->SetMaximum(1.789868);
   ...
   hNuclearModification4->SetBinContent(1,1.308055);
   hNuclearModification4->SetBinContent(2,0.8514618);
   hNuclearModification4->SetBinError(1,0.5308389);
   hNuclearModification4->SetBinError(2,0.297076);
   hNuclearModification4->SetEntries(12.60259);
   ...
   hNuclearModification5->SetBinContent(1,1.308055);
   hNuclearModification5->SetBinContent(2,0.8514618);
   hNuclearModification5->SetBinError(1,0.5308389);
   hNuclearModification5->SetBinError(2,0.297076);
   hNuclearModification5->SetEntries(12.60259);
