...
void HypoTest(){
    ...
    //RooAddPdf* model_syst_noconstr = new RooAddPdf(Form("model_syst_noconstr"),"",RooArgList(*bkg,*sig),RooArgList(*nbkg,*nsig_syst));
    ...
    ws->factory( "SUM::model_syst_noconstr(nbkg_abs * bkg_abs, nsig_syst * sig_abs)" ); RooAbsPdf* model_syst_noconstr = (RooAddPdf*)ws->pdf("model_syst_noconstr");
