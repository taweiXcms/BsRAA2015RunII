...
int BfinderAna_chain(
        ...
        //TString outfile="/data/cdzn/NP_Background/PbPb/BJpsiMM_PbPb_nonprompt_15_30.root",
       //TString outfile="BJpsiMM_PbPb_nonprompt_30.root",
       // TString outfile="/data/cdzn/NP_Background/PbPb/BJpsiMM_PbPb_nonprompt_09_12.root",
...
int main(int argc, char *argv[])
{
    ...
    if(argc==3)
    {
        BfinderAna_chain(argv[1], argv[2]);
    }
    else
    {
