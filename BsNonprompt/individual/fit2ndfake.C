...
TString infilepp = "/data/cdzn/NP_Background/pp/BJpsiMM_pp_NP.root";
 //TString infilePbPb = "/data/cdzn/NP_Background/PbPb/BJpsiMM_PbPb_nonprompt_09_12.root";                                                                                                                                                                   //TString infilePbPb = "/data/cdzn/NP_Background/PbPb/BJpsiMM_PbPb_nonprompt_12_15.root";
...
//	hempty->SetMaximum(Bnosig->GetMaximum()*1.2);
	...
	leg->AddEntry(h,"Peaking background stack:","p");
        leg->AddEntry(cp1,"2.case: B_{s}^{0} to Jpsi K K (not make phi)","p");
	TLatex * tlatex;
	...
	h->Write();
	f->Write();
	if(ispp) c->SaveAs(Form("plotspp/2ndfitNP_pp.png"));
	else c->SaveAs(Form("plotsPbPb/2ndfitNP_PbPb.png"));
}
