...
///Bmu1TMOneStationTight & Bmu2TMOneStationTight  boolen
 ...
 //Bmu1InStripLayer && Bmu2InStripLayer 
      int Bmu1InStripLayer = MuonInfo->i_nStripLayer[BInfo->uj_rfmu1_index[BInfo->rfuj_index[j]]];                                                              int Bmu2InStripLayer = MuonInfo->i_nStripLayer[BInfo->uj_rfmu2_index[BInfo->rfuj_index[j]]]; 
 
 //Bmu1dxyPV && Bmu2dxyPV
      float Bmu1dxyPV = MuonInfo->dxyPV[BInfo->uj_rfmu1_index[BInfo->rfuj_index[j]]];                                                                           float Bmu2dxyPV = MuonInfo->dxyPV[BInfo->uj_rfmu2_index[BInfo->rfuj_index[j]]];
 
 //Bmu1dzPV && Bmu2dzPV
      float Bmu1dzPV = MuonInfo->dzPV[BInfo->uj_rfmu1_index[BInfo->rfuj_index[j]]];                                                                             float Bmu2dzPV = MuonInfo->dzPV[BInfo->uj_rfmu2_index[BInfo->rfuj_index[j]]];

//Bmu1isGlobalMuon && Bmu2isGlobalMuon
     bool Bmu1isGlobalMuon= MuonInfo->isGlobalMuon[BInfo->uj_rfmu1_index[BInfo->rfuj_index[j]]];                                                               bool Bmu2isGlobalMuon= MuonInfo->isGlobalMuon[BInfo->uj_rfmu2_index[BInfo->rfuj_index[j]]]; 
