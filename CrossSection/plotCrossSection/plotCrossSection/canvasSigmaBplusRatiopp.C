...
//=========  (Thu Mar  1 21:51:35 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7335.707);
   Graph_gaeCrossSyst3002->SetMaximum(9939.621);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6986933);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9467045);
