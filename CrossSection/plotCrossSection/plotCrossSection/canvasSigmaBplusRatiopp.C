...
//=========  (Fri Apr 20 16:36:51 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   Graph_gaeCrossSyst3002->SetMinimum(6767.429);
   Graph_gaeCrossSyst3002->SetMaximum(415240.4);
...
tex->SetNDC();
   ...
   TLegend *leg = new TLegend(0.52,0.7,0.85,0.85,NULL,"brNDC");
   leg->SetBorderSize(0);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.6458415);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.203102);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6639301);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.291001);
