...
//=========  (Mon Apr 16 15:09:57 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(2,8461.565);
   hPtSigma2->SetBinError(1,36797.17);
   hPtSigma2->SetBinError(2,1056.242);
   hPtSigma2->SetEntries(83.16262);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(6885.957);
   Graph_gaeCrossSyst3002->SetMaximum(418200.1);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.6566117);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.241158);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6768427);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.299485);
