...
//=========  (Thu Mar  8 12:35:32 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,221106.6);
   hPtSigma2->SetBinContent(2,37822.15);
   hPtSigma2->SetBinContent(3,9813.579);
   hPtSigma2->SetBinContent(4,790.4343);
   hPtSigma2->SetBinError(1,28956.84);
   hPtSigma2->SetBinError(2,6648.018);
   hPtSigma2->SetBinError(3,1911.413);
   hPtSigma2->SetBinError(4,366.034);
   hPtSigma2->SetBinError(5,nan);
   hPtSigma2->SetEntries(81.95075);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(624.0312);
   Graph_gaeCrossSyst3002->SetMaximum(262754.2);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.2065085);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.595534);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.4377559);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.502642);
