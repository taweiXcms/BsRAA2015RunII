...
//=========  (Fri Dec 15 18:55:07 2017) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,10881.34);
   hPtSigma2->SetBinError(1,1171.182);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(86.32104);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(9381.224);
   Graph_gaeCrossSyst3002->SetMaximum(12381.46);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.9025397);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.170259);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.8935197);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.179279);
