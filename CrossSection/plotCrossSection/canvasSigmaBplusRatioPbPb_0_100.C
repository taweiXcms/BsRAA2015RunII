...
//=========  (Sat Nov 25 22:21:24 2017) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,6820.071);
   hPtSigma2->SetBinError(1,2418.382);
   hPtSigma2->SetEntries(7.952948);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(5347.521);
   Graph_gaeCrossSyst3001->SetMaximum(8292.621);
