...
//=========  (Fri Nov 17 18:42:36 2017) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,2895.087);
   hPtSigma2->SetBinError(1,1090.001);
   hPtSigma2->SetEntries(7.054552);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(2894.987);
   Graph_gaeCrossSyst3001->SetMaximum(2896.187);
