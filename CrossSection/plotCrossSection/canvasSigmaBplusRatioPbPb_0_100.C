...
//=========  (Fri Sep 22 05:51:28 2017) by ROOT version6.02/13
   TCanvas *cSigma = new TCanvas("cSigma", "",0,0,600,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cSigma->SetHighLightColor(2);
   cSigma->Range(0.02518833,1.47101,68.74055,7.348675);
   ...
   TH2F *hemptySigma1 = new TH2F("hemptySigma1","",50,10,65,10,100,1e+07);
   ...
   hPtSigma2->SetBinContent(1,3788.619);
   hPtSigma2->SetBinError(1,1888.756);
   hPtSigma2->SetEntries(4.023556);
   ...
   TH1F *Graph_gaeCrossSyst3001 = new TH1F("Graph_gaeCrossSyst3001","Graph",100,10.5,64.5);
   Graph_gaeCrossSyst3001->SetMinimum(3788.519);
   Graph_gaeCrossSyst3001->SetMaximum(3789.719);
