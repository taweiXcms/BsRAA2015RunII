...
//=========  (Sat Nov 25 16:06:08 2017) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,5808.926);
   hPtSigma2->SetBinError(1,2190.064);
   hPtSigma2->SetEntries(7.035227);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(4554.649);
   Graph_gaeCrossSyst3001->SetMaximum(7063.203);
