...
//=========  (Sun Mar  4 22:41:35 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7743.127);
   Graph_gaeCrossSyst3002->SetMaximum(10491.2);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7374983);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9992402);
