...
//=========  (Thu Mar  1 21:51:44 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7742.933);
   Graph_gaeCrossSyst3002->SetMaximum(10491.4);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7374798);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9992588);
