...
//=========  (Thu Mar  8 12:35:37 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,9117.165);
   hPtSigma2->SetBinError(1,1325.607);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(47.30315);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7773.647);
   Graph_gaeCrossSyst3002->SetMaximum(10460.68);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.7168595);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.019879);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7404051);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9963334);
