...
//=========  (Thu Mar  8 12:35:35 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   Graph_gaeCrossSyst3002->SetMinimum(6956.174);
   Graph_gaeCrossSyst3002->SetMaximum(9360.644);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6625445);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.8915595);
