...
//=========  (Mon Apr 16 14:15:13 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   Graph_gaeCrossSyst3002->SetMinimum(6941.987);
   Graph_gaeCrossSyst3002->SetMaximum(465848.1);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6691748);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.454987);
