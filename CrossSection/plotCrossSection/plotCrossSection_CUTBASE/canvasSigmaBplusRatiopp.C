...
//=========  (Tue Apr 17 22:07:37 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,364817.4);
   hPtSigma2->SetBinContent(2,8537.058);
   hPtSigma2->SetBinError(1,47540.6);
   hPtSigma2->SetBinError(2,1117.837);
   hPtSigma2->SetEntries(61.64152);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(6945.278);
   Graph_gaeCrossSyst3002->SetMaximum(478774.3);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.6422409);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.415122);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6657086);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.497295);
