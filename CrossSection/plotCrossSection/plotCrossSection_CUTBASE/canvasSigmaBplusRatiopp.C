...
//=========  (Thu Apr 12 23:30:15 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,364464.5);
   hPtSigma2->SetBinContent(2,8530.416);
   hPtSigma2->SetBinError(1,47527.32);
   hPtSigma2->SetBinError(2,1117.237);
   hPtSigma2->SetEntries(61.55725);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(6955.569);
   Graph_gaeCrossSyst3002->SetMaximum(465439.1);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.6417278);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.41386);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6708772);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.453509);
