...
//=========  (Sun Mar  4 22:41:33 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   pSigma->Draw();
   pSigma->cd();
   pSigma->Range(1.83879,2,58.06045,7.462963);
   ...
   hPtSigma2->SetBinContent(1,8158.409);
   hPtSigma2->SetBinError(1,1108.289);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(54.18819);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(6928.864);
   Graph_gaeCrossSyst3002->SetMaximum(9387.954);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.6503805);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(0.9037236);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6599434);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.8941607);
