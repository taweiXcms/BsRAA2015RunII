...
//=========  (Tue Apr 17 22:07:42 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,364785);
   hPtSigma2->SetBinContent(2,8915.101);
   hPtSigma2->SetBinError(1,78340.23);
   hPtSigma2->SetBinError(2,1320.321);
   hPtSigma2->SetEntries(22.74853);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7252.833);
   Graph_gaeCrossSyst3002->SetMaximum(478697.5);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.6505561);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.524309);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7015242);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.4939);
