...
//=========  (Thu Apr 12 23:11:50 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(2,0.1265151);
   hEff2->SetBinContent(3,0.2084732);
   hEff2->SetBinError(1,0.0001561845);
   hEff2->SetBinError(2,0.0009656257);
   hEff2->SetBinError(3,0.001138583);
   hEff2->SetEntries(55870.24);
   hEff2->SetStats(0);
