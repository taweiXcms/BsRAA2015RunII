...
//=========  (Thu Apr 12 23:11:19 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.002625869);
   hEff2->SetBinContent(2,0.04823276);
   hEff2->SetBinError(1,0.0001300392);
   hEff2->SetBinError(2,0.001065046);
   hEff2->SetEntries(2246.809);
   hEff2->SetStats(0);
