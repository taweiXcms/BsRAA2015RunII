...
//=========  (Tue Feb 13 22:25:53 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,12125.3);
   hPtSigma2->SetBinError(1,2325.094);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(27.19597);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(10297.76);
   Graph_gaeCrossSyst3002->SetMaximum(13952.85);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.8891354);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.420627);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.9808153);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.328947);
