...
//=========  (Tue Apr 17 23:47:42 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.0206858);
   hEff2->SetBinContent(2,0.1547794);
   hEff2->SetBinError(1,0.0001613677);
   hEff2->SetBinError(2,0.0007357658);
   hEff2->SetEntries(54262.48);
   hEff2->SetStats(0);
