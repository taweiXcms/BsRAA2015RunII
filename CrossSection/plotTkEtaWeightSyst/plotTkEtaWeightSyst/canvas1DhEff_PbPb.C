...
//=========  (Tue Apr 17 23:52:03 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.002762682);
   hEff2->SetBinContent(2,0.04921234);
   hEff2->SetBinError(1,0.0001351257);
   hEff2->SetBinError(2,0.001049055);
   hEff2->SetEntries(2414.607);
   hEff2->SetStats(0);
