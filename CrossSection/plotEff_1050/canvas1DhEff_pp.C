...
//=========  (Mon Feb 12 00:38:06 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(2,0.1205854);
   hEff2->SetBinContent(3,0.2028882);
   hEff2->SetBinContent(4,0.2731772);
   hEff2->SetBinContent(5,6.77238e-77);
   hEff2->SetBinError(0,4.316175e-05);
   hEff2->SetBinError(1,0.0003499573);
   hEff2->SetBinError(2,0.0009412257);
   hEff2->SetBinError(3,0.001319639);
   hEff2->SetBinError(4,0.001983989);
   hEff2->SetBinError(5,nan);
   hEff2->SetEntries(60078.01);
   hEff2->SetStats(0);
