...
//=========  (Fri Sep 22 06:08:26 2017) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   TH1F *Graph_gNuclearModification_UnCor3002 = new TH1F("Graph_gNuclearModification_UnCor3002","Graph",100,18.21429,56.78571);
   Graph_gNuclearModification_UnCor3002->SetMinimum(0.5859422);
   Graph_gNuclearModification_UnCor3002->SetMaximum(1.785942);
   ...
   TH1F *Graph_gNuclearModification_Cor3003 = new TH1F("Graph_gNuclearModification_Cor3003","Graph",100,10.5,64.5);
   Graph_gNuclearModification_Cor3003->SetMinimum(0.5859422);
   Graph_gNuclearModification_Cor3003->SetMaximum(1.785942);
   ...
   hNuclearModification2->SetBinContent(1,0.6859422);
   hNuclearModification2->SetBinError(1,0.3537844);
   hNuclearModification2->SetEntries(3.759219);
   ...
   box->SetLineColor(16);
   box->Draw();
   Double_t xAxis2[2] = {15, 60}; 
   
   TH1D *hNuclearModification3 = new TH1D("hNuclearModification3","",1, xAxis2);
   hNuclearModification3->SetBinContent(1,0.6859422);
   hNuclearModification3->SetBinError(1,0.3537844);
   hNuclearModification3->SetEntries(3.759219);
