...
//=========  (Mon Mar 19 11:32:09 2018) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   TLegend *leg = new TLegend(0.4,0.66,0.81,0.92,NULL,"brNDC");
   leg->SetBorderSize(0);
   ...
   entry->SetTextFont(42);
   entry->SetTextSize(0.038);
   entry=leg->AddEntry("gNuclearModification_UnCor","B_{s} R_{AA}","pf");
   ...
   Double_t gNuclearModification_fx3004[1] = {
   32.5};
   Double_t gNuclearModification_fy3004[1] = {
   0.5485694};
   Double_t gNuclearModification_felx3004[1] = {
   17.5};
   Double_t gNuclearModification_fely3004[1] = {
   0.1076159};
   Double_t gNuclearModification_fehx3004[1] = {
   17.5};
   Double_t gNuclearModification_fehy3004[1] = {
   0.1076159};
   grae = new TGraphAsymmErrors(1,gNuclearModification_fx3004,gNuclearModification_fy3004,gNuclearModification_felx3004,gNuclearModification_fehx3004,gNuclearModification_fely3004,gNuclearModification_fehy3004);
   grae->SetName("gNuclearModification");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_gNuclearModification3004 = new TH1F("Graph_gNuclearModification3004","Graph",100,11.5,53.5);
   Graph_gNuclearModification3004->SetMinimum(0.4194303);
   Graph_gNuclearModification3004->SetMaximum(0.6777085);
   ...
   gre->Draw("p");
   Double_t xAxis9[2] = {15, 50}; 
   
   TH1D *hNuclearModification10 = new TH1D("hNuclearModification10","",1, xAxis9);
   hNuclearModification10->SetBinContent(1,0.5485694);
   hNuclearModification10->SetBinError(1,0.2321647);
   hNuclearModification10->SetEntries(5.58304);
   ...
   Double_t xAxis10[2] = {15, 50}; 
   
   TH1D *hNuclearModification11 = new TH1D("hNuclearModification11","",1, xAxis10);
   hNuclearModification11->SetBinContent(1,0.5485694);
   hNuclearModification11->SetBinError(1,0.2321647);
   hNuclearModification11->SetEntries(5.58304);
   ...
   TH2F *hemptyEff_copy12 = new TH2F("hemptyEff_copy12","",50,0.5,600,10,0,1.55);
   ...
   hemptyEff_copy12->GetXaxis()->SetTitleSize(0.05);
   ...
   hemptyEff_copy12->GetYaxis()->SetTitleSize(0.05);
   hemptyEff_copy12->GetYaxis()->SetTitleOffset(1.1);
