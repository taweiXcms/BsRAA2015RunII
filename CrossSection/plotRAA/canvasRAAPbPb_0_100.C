...
//=========  (Sat Nov 25 22:21:27 2017) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3001->SetMinimum(0.4344226);
   Graph_gNuclearModification3001->SetMaximum(0.7221351);
   ...
   hNuclearModification2->SetBinContent(1,0.5782788);
   hNuclearModification2->SetBinError(1,0.2140478);
   hNuclearModification2->SetEntries(7.298824);
   ...
   hNuclearModification3->SetBinContent(1,0.5782788);
   hNuclearModification3->SetBinError(1,0.2140478);
   hNuclearModification3->SetEntries(7.298824);
