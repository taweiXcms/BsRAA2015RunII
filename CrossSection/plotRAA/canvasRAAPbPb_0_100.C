...
//=========  (Mon Nov 27 10:14:14 2017) by ROOT version6.02/13
...
tex->SetNDC();
   ...
   Graph_gNuclearModification3001->SetMinimum(0.4344212);
   Graph_gNuclearModification3001->SetMaximum(0.7221328);
   ...
   hNuclearModification2->SetBinContent(1,0.578277);
   hNuclearModification2->SetBinError(1,0.2140466);
   hNuclearModification2->SetEntries(7.298865);
   ...
   hNuclearModification3->SetBinContent(1,0.578277);
   hNuclearModification3->SetBinError(1,0.2140466);
   hNuclearModification3->SetEntries(7.298865);
