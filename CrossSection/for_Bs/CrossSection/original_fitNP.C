...
void fitNP(
int usePbPb=1, 
TString inputdata="/afs/cern.ch/work/c/cdozen/UP_BFINDER/CMSSW_7_5_8_patch3/src/Bfinder/Bfinder/Bntuple/looper/loop_BJpsiMM_PbPb_09_12.root" , 
...
TString cut = "TMath::Abs(By)<2.4&&abs(Bmumumass-3.096916)<0.15&&Bmass>5.&&Bmass<6.&&Btrk1Pt>1.63&&Btrk2Pt>1.63&& Bchi2cl>0.0057&&(Bd0/Bd0Err)>5.&&cos(Bdtheta)>0.993&&Bmu1pt>1.5&&Bmu2pt>1.5&&TMath::Abs(Btktkmass-1.019455)<0.05&&Blxy>0.0337", 
TString cutmcgen="TMath::Abs(Gy)<2.4&&Bgen!=23333", 
int isMC=1, 
Double_t luminosity=1., 
int doweight=0, 
TString collsyst="PbPb", 
TString outputfile="ROOTfiles/mytest.root", 
Float_t centmin=10., Float_t centmax=1000.)
{
