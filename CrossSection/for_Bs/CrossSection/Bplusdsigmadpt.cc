...
void Bplusdsigmadpt(TString inputFONLLdat = "pp_Bs_new_y2p4", ///"pp_Bs1010101_5p03TeV_y2p4", 
//void Bplusdsigmadpt(TString inputFONLLdat ="pp_Bs5_5p03TeV_y2p4",// "pp_Bs4_5p03TeV_y2p4", 
TString outputFONLL = "fonllOutput_pp_Bs.root",
TString label = "pp")
{
  //double norm=0.401*0.5;           //FF of B->B+, i.e., B fraction//fonll i 2 ye bolmek icin 0.5 ile carptim cunku Bs icin uretilmis fonll antisi icin de ikiye bolduk ,, ama kesin degil simdilik.
  double norm=0.103;           //FF of B->B+, i.e., B fraction//fonll i 2 ye bolmek icin 0.5 ile carptim cunku Bs icin uretilmis fonll antisi icin de ikiye bolduk ,, ama kesin degil simdilik.
 ...
 // gaeSigmaBplus->SetName("gaeSigmaBs");
