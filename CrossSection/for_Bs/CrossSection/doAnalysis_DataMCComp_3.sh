...
OUTPUTFILEPbPb_NP_comp="ROOTfiles/NPFitPbPb.root"
RMKNAME="test5_base_cosBdtheta_MC"
...
OUTPUTFILEPbPb_NP_comp="ROOTfiles/NPFitPbPb.root"
LABELPbPb="PbPb"
RMKNAME="test5__opt_cosBdtheta_MC"
g++ fitB_comp.C $(root-config --cflags --libs) -g -o fitB_comp.exe
./fitB_comp.exe 0 "$INPUTMCPP"  "$INPUTMCPP"  "$TRGPPMC" "$CUTPP"   "$SELGENPP"   1   1   "$ISDOWEIGHTPP"   "$LABELPP"  "$OUTPUTFILEPbPb_comp" "$OUTPUTFILEPP_NP" "$comp_value" "$comp_nBin" "$comp_min" "$comp_max" "$RMKNAME"
rm fitB_comp.exe
...
#RMKNAME="20160628_test4" ## without weighting, only pp
RMKNAME="20160628_test5" #
...
./Draw_DataMCComp.exe "$INPUTDATA" "$INPUTMC" "$VAR" 0 0 0.0 0.2 0 "$RMKNAME"
...
g++ CompareDataMC.C $(root-config --cflags --libs) -g -o Draw_DataMCComp.exe
./Draw_DataMCComp.exe "$INPUTDATA" "$INPUTMC" "$VAR" 0 1 0.0 0.2 0 "$RMKNAME"
rm Draw_DataMCComp.exe
...
g++ CompareDataMC.C $(root-config --cflags --libs) -g -o Draw_DataMCComp.exe
./Draw_DataMCComp.exe "$INPUTDATA" "$INPUTMC" "$VAR" 0 0 0.98 1.0 0 "$RMKNAME"
rm Draw_DataMCComp.exe
...
g++ CompareDataMC.C $(root-config --cflags --libs) -g -o Draw_DataMCComp.exe
./Draw_DataMCComp.exe "$INPUTDATA" "$INPUTMC" "$VAR" 0 1 0.98 1.0 0 "$RMKNAME"
rm Draw_DataMCComp.exe
...
g++ CompareDataMC.C $(root-config --cflags --libs) -g -o Draw_DataMCComp.exe
./Draw_DataMCComp.exe "$INPUTDATA" "$INPUTMC" "$VAR" 0 0 2.0 8.0 0 "$RMKNAME"
rm Draw_DataMCComp.exe
...
g++ CompareDataMC.C $(root-config --cflags --libs) -g -o Draw_DataMCComp.exe
./Draw_DataMCComp.exe "$INPUTDATA" "$INPUTMC" "$VAR" 0 1 2.0 8.0 0 "$RMKNAME"
rm Draw_DataMCComp.exe
