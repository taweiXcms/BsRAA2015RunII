...
//=========  (Mon Sep 25 20:08:46 2017) by ROOT version6.02/13
   TCanvas *canvas1D = new TCanvas("canvas1D", "",279,1103,600,600);
   gStyle->SetOptStat(0);
   ...
   hEff2->SetBinContent(1,0.004015347);
   hEff2->SetBinContent(2,0.05831815);
   hEff2->SetBinContent(3,0.1452246);
   hEff2->SetBinContent(4,0.235508);
   hEff2->SetBinContent(5,0.1798561);
   hEff2->SetBinError(1,0.0003033635);
   hEff2->SetBinError(2,0.002272303);
   hEff2->SetBinError(3,0.006754313);
   hEff2->SetBinError(4,0.01115547);
   hEff2->SetBinError(5,0.1206241);
   hEff2->SetEntries(1119.707);
   hEff2->SetStats(0);
