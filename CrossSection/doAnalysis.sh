...
DOANALYSISPP_FITONSAVED_PbPbBDT=1
...
./plotSth.exe 0 "$INPUTDATAPPCANDWISE" "$INPUTMCPPCANDWISE" "Bpt" "$TRGPP" "$TRGPPMC" "$CUTPP" "$SELGENPP" "$ISMCPP" 1 "$ISDOWEIGHTPP" "$LABELPP" "" "plotSth" "$NPFIT_PP" 0 "0" "100" 0
./plotSth.exe 1 "$INPUTDATAPbPbCANDWISE" "$INPUTMCPbPbCANDWISE" "Bpt" "$TRGPbPb" "$TRGPbPbMC" "$CUTPbPb" "$SELGENPbPb" "$ISMCPbPb" 1 "$ISDOWEIGHTPbPb" "$LABELPbPb" "" "plotSth" "$NPFIT_PbPb" 0 "$CENTPbPbMIN" "$CENTPbPbMAX" 0
./plotSth.exe 1 "$INPUTMCPPCANDWISE" "$INPUTMCPbPbCANDWISE" "Bpt" "$TRGPPMC" "$TRGPbPbMC" "$CUTPP" "$CUTPbPb" "$ISMCPbPb" 1 "$ISDOWEIGHTPbPb" "$LABELPbPb" "" "plotSth" "$NPFIT_PbPb" 0 "$CENTPbPbMIN" "$CENTPbPbMAX" 1
rm plotSth.exe
fi 
