...
//=========  (Tue Feb 13 22:25:49 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.003441087);
   hEff2->SetBinContent(1,0.07315417);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,5.121368e-05);
   hEff2->SetBinError(1,0.0005145316);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(20214.08);
   hEff2->SetStats(0);
