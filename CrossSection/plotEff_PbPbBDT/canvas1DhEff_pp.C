...
//=========  (Mon Feb 12 01:11:56 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.002178015);
   hEff2->SetBinContent(1,0.09269837);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,3.99017e-05);
   hEff2->SetBinError(1,0.0005676152);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(26670.8);
   hEff2->SetStats(0);
