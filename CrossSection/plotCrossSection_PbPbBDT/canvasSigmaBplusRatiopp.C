...
//=========  (Mon Feb 12 02:03:22 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,11094.67);
   hPtSigma2->SetBinError(1,1529.626);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(52.60883);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(9422.463);
   Graph_gaeCrossSyst3002->SetMaximum(12766.88);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.88189);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.231546);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.8974476);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.215989);
