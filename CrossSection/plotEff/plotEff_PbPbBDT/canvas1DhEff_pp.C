...
//=========  (Thu Mar  1 20:48:51 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.002426339);
   hEff2->SetBinContent(1,0.09791483);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,4.213032e-05);
   hEff2->SetBinError(1,0.0005845441);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(28058.37);
   hEff2->SetStats(0);
