...
//=========  (Tue Apr 17 17:32:03 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.007308384);
   hEff2->SetBinContent(2,0.1066062);
   hEff2->SetBinError(1,9.329984e-05);
   hEff2->SetBinError(2,0.000613104);
   hEff2->SetEntries(33740.22);
   hEff2->SetStats(0);
