...
//=========  (Thu Mar  1 20:46:10 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001663633);
   hEff2->SetBinContent(1,0.03636074);
   hEff2->SetBinContent(2,0.1151193);
   hEff2->SetBinContent(3,0.1870266);
   hEff2->SetBinContent(4,0.250162);
   hEff2->SetBinContent(5,6.77238e-77);
   hEff2->SetBinError(0,4.406047e-05);
   hEff2->SetBinError(1,0.0003464004);
   hEff2->SetBinError(2,0.0009221792);
   hEff2->SetBinError(3,0.001279217);
   hEff2->SetBinError(4,0.001928122);
   hEff2->SetBinError(5,nan);
   hEff2->SetEntries(54792.15);
   hEff2->SetStats(0);
