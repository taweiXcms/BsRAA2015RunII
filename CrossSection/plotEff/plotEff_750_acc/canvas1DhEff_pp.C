...
//=========  (Tue Apr 17 17:10:38 2018) by ROOT version6.02/13
   ...
   hemptyEff1->Draw("");
   Double_t xAxis1[5] = {7, 12, 15, 20, 50}; 
   
   TH1D *hEff2 = new TH1D("hEff2","",4, xAxis1);
   hEff2->SetBinContent(1,0.01208057);
   hEff2->SetBinContent(2,0.07156386);
   hEff2->SetBinContent(3,0.1271052);
   hEff2->SetBinContent(4,0.2103738);
   hEff2->SetBinError(1,0.0001413591);
   hEff2->SetBinError(2,0.0007042589);
   hEff2->SetBinError(3,0.0009651571);
   hEff2->SetBinError(4,0.001121631);
   hEff2->SetEntries(65548.67);
   hEff2->SetStats(0);
