...
//=========  (Fri Apr  6 14:00:05 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.002763777);
   hEff2->SetBinContent(2,0.04837108);
   hEff2->SetBinError(1,0.0001352269);
   hEff2->SetBinError(2,0.001033158);
   hEff2->SetEntries(2408.373);
   hEff2->SetStats(0);
