...
//=========  (Thu Mar  1 20:47:31 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.008993902);
   hEff2->SetBinContent(1,0.1410809);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,8.351381e-05);
   hEff2->SetBinError(1,0.0007042627);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(40129.84);
   hEff2->SetStats(0);
