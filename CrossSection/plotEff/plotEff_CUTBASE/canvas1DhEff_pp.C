...
//=========  (Tue Apr 17 17:44:57 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.01463948);
   hEff2->SetBinContent(2,0.1407991);
   hEff2->SetBinError(1,0.0001350754);
   hEff2->SetBinError(2,0.0007078629);
   hEff2->SetEntries(46525.04);
   hEff2->SetStats(0);
