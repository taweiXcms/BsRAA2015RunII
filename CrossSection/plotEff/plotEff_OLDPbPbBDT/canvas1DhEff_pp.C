...
//=========  (Tue Apr 17 17:32:42 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.004605825);
   hEff2->SetBinContent(2,0.09798751);
   hEff2->SetBinError(1,7.304933e-05);
   hEff2->SetBinError(2,0.0005836892);
   hEff2->SetEntries(30417.64);
   hEff2->SetStats(0);
