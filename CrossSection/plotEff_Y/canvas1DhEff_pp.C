...
//=========  (Wed Dec 13 17:52:56 2017) by ROOT version6.02/13
   TCanvas *canvas1D = new TCanvas("canvas1D", "",0,0,600,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   canvas1D->SetHighLightColor(2);
   canvas1D->Range(-0.3,-0.07500001,2.7,0.675);
   ...
   TH2F *hemptyEff1 = new TH2F("hemptyEff1","",50,0,2.4,10,0,0.6);
   ...
   hEff2->SetBinContent(1,0.1783113);
   hEff2->SetBinContent(2,0.1874747);
   hEff2->SetBinContent(3,0.1875774);
   hEff2->SetBinContent(4,0.09361532);
   hEff2->SetBinError(1,0.001550909);
   hEff2->SetBinError(2,0.001626187);
   hEff2->SetBinError(3,0.001727441);
   hEff2->SetBinError(4,0.001067532);
   hEff2->SetEntries(45629.53);
   hEff2->SetStats(0);
