...
//=========  (Sat Feb 23 20:35:45 2019) by ROOT version6.02/13
   ...
   c1->Range(4.76834,-9.990243,6.055341,58.90799);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   h11->SetBinContent(5,3);
   h11->SetBinContent(6,2);
   h11->SetBinContent(8,3);
   h11->SetBinContent(11,1);
   h11->SetBinContent(17,1);
   h11->SetBinContent(18,9);
   h11->SetBinContent(19,24);
   h11->SetBinContent(20,2);
   h11->SetBinContent(22,2);
   h11->SetMinimum(0);
   h11->SetMaximum(52.01816);
   h11->SetEntries(50);
   h11->SetStats(0);
   h11->SetLineWidth(4);
   ...
   background11->SetParameter(3,15.91072);
   background11->SetParError(3,0);
   background11->SetParLimits(3,0,0);
   background11->SetParameter(4,-2.941901);
   ...
   fmass12->SetParameter(0,0.7596517);
   fmass12->SetParError(0,0.1232979);
   fmass12->SetParLimits(0,0,0);
   fmass12->SetParameter(1,5.366257);
   fmass12->SetParError(1,0.002556075);
   fmass12->SetParLimits(1,0,0);
   fmass12->SetParameter(2,0.01364332);
   ...
   fmass12->SetParameter(7,0.7963075);
   fmass12->SetParError(7,0);
   fmass12->SetParLimits(7,0,0);
   fmass12->SetParameter(8,0.03820389);
   ...
   f13->SetParameter(0,0.7596517);
   f13->SetParError(0,0.1232979);
   f13->SetParLimits(0,0,0);
   f13->SetParameter(1,5.366257);
   f13->SetParError(1,0.002556075);
   f13->SetParLimits(1,0,0);
   f13->SetParameter(2,0.01364332);
   f13->SetParError(2,0);
   f13->SetParLimits(2,0.01364332,0.01364332);
   f13->SetParameter(3,15.91072);
   f13->SetParError(3,0.1692961);
   f13->SetParLimits(3,0,0);
   f13->SetParameter(4,-2.941901);
   f13->SetParError(4,0.03203841);
   f13->SetParLimits(4,0,0);
   f13->SetParameter(5,-342218.7);
   f13->SetParError(5,5.656854);
   f13->SetParLimits(5,0,0);
   f13->SetParameter(6,0);
   f13->SetParError(6,1);
   f13->SetParLimits(6,0,0);
   f13->SetParameter(7,0.7963075);
   f13->SetParError(7,0);
   f13->SetParLimits(7,0.7963075,0.7963075);
   f13->SetParameter(8,0.03820389);
   f13->SetParError(8,0);
   f13->SetParLimits(8,0.03820389,0.03820389);
   f13->Draw("same");
   ...
   h1_copy2->SetBinContent(5,3);
   h1_copy2->SetBinContent(6,2);
   h1_copy2->SetBinContent(8,3);
   h1_copy2->SetBinContent(11,1);
   h1_copy2->SetBinContent(17,1);
   h1_copy2->SetBinContent(18,9);
   h1_copy2->SetBinContent(19,24);
   h1_copy2->SetBinContent(20,2);
   h1_copy2->SetBinContent(22,2);
   h1_copy2->SetMinimum(0);
   h1_copy2->SetMaximum(52.01816);
   h1_copy2->SetEntries(50);
   ...
   f11->SetParameter(0,0.7596517);
   f11->SetParError(0,0.1232979);
   f11->SetParLimits(0,0,0);
   f11->SetParameter(1,5.366257);
   f11->SetParError(1,0.002556075);
   f11->SetParLimits(1,0,0);
   f11->SetParameter(2,0.01364332);
   f11->SetParError(2,0);
   f11->SetParLimits(2,0.01364332,0.01364332);
   f11->SetParameter(3,15.91072);
   f11->SetParError(3,0.1692961);
   f11->SetParLimits(3,0,0);
   f11->SetParameter(4,-2.941901);
   f11->SetParError(4,0.03203841);
   f11->SetParLimits(4,0,0);
   f11->SetParameter(5,-342218.7);
   f11->SetParError(5,5.656854);
   f11->SetParLimits(5,0,0);
   f11->SetParameter(6,0);
   f11->SetParError(6,1);
   f11->SetParLimits(6,0,0);
   f11->SetParameter(7,0.7963075);
   f11->SetParError(7,0);
   f11->SetParLimits(7,0.7963075,0.7963075);
   f11->SetParameter(8,0.03820389);
   f11->SetParError(8,0);
   f11->SetParLimits(8,0.03820389,0.03820389);
...
tex->SetNDC();
   ...
   f12->SetParameter(0,0.7596517);
   f12->SetParError(0,0.1232979);
   f12->SetParLimits(0,0,0);
   f12->SetParameter(1,5.366257);
   f12->SetParError(1,0.002556075);
   f12->SetParLimits(1,0,0);
   f12->SetParameter(2,0.01364332);
   f12->SetParError(2,0);
   f12->SetParLimits(2,0.01364332,0.01364332);
   f12->SetParameter(3,15.91072);
   f12->SetParError(3,0.1692961);
   f12->SetParLimits(3,0,0);
   f12->SetParameter(4,-2.941901);
   f12->SetParError(4,0.03203841);
   f12->SetParLimits(4,0,0);
   f12->SetParameter(5,-342218.7);
   f12->SetParError(5,5.656854);
   ...
   f12->SetParError(7,0);
   f12->SetParLimits(7,0.7963075,0.7963075);
   f12->SetParameter(8,0.03820389);
   f12->SetParError(8,0);
   f12->SetParLimits(8,0.03820389,0.03820389);
   f12->Draw("same");
   ...
   h13->SetBinContent(5,3);
   h13->SetBinContent(6,2);
   h13->SetBinContent(8,3);
   h13->SetBinContent(11,1);
   h13->SetBinContent(17,1);
   h13->SetBinContent(18,9);
   h13->SetBinContent(19,24);
   h13->SetBinContent(20,2);
   h13->SetBinContent(22,2);
   h13->SetMinimum(0);
   h13->SetMaximum(52.01816);
   h13->SetEntries(50);
   h13->SetStats(0);
   h13->SetLineWidth(4);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.54,"Significance = 6.1");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.44,"Yield = 38");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
