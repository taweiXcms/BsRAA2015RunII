...
//=========  (Thu Jan 24 10:11:34 2019) by ROOT version6.02/13
   ...
   c1->Range(4.76834,-17.87529,6.055341,105.4026);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   h11->SetBinContent(3,6);
   h11->SetBinContent(4,3);
   h11->SetBinContent(5,5);
   h11->SetBinContent(6,6);
   h11->SetBinContent(7,3);
   h11->SetBinContent(8,3);
   h11->SetBinContent(9,4);
   h11->SetBinContent(10,1);
   h11->SetBinContent(11,6);
   h11->SetBinContent(12,2);
   h11->SetBinContent(13,13);
   h11->SetBinContent(14,7);
   h11->SetBinContent(15,4);
   h11->SetBinContent(16,5);
   h11->SetBinContent(17,8);
   h11->SetBinContent(18,22);
   h11->SetBinContent(19,45);
   h11->SetBinContent(20,9);
   h11->SetBinContent(21,3);
   h11->SetBinContent(22,3);
   h11->SetBinContent(23,2);
   h11->SetBinContent(24,3);
   h11->SetBinContent(25,1);
   h11->SetBinContent(27,2);
   h11->SetBinContent(28,2);
   h11->SetBinContent(30,1);
   h11->SetBinContent(31,4);
   h11->SetBinContent(32,3);
   h11->SetBinContent(33,2);
   h11->SetBinContent(34,3);
   h11->SetBinContent(35,3);
   h11->SetBinContent(36,1);
   h11->SetBinContent(37,2);
   h11->SetBinContent(38,2);
   h11->SetBinContent(39,4);
   h11->SetBinContent(40,1);
   h11->SetBinContent(41,4);
   h11->SetBinContent(42,2);
   h11->SetBinContent(43,3);
   h11->SetBinContent(44,1);
   h11->SetBinContent(45,2);
   h11->SetBinContent(46,2);
   h11->SetBinContent(47,2);
   h11->SetBinContent(48,3);
   h11->SetBinContent(50,3);
   h11->SetMinimum(0);
   h11->SetMaximum(93.07477);
   h11->SetEntries(233);
   h11->SetStats(0);
   h11->SetLineWidth(4);
   ...
   background11->SetParameter(3,23.10204);
   background11->SetParError(3,0);
   background11->SetParLimits(3,0,0);
   background11->SetParameter(4,-3.620556);
   ...
   fmass12->SetParameter(0,1.470999);
   fmass12->SetParError(0,0.1899615);
   fmass12->SetParLimits(0,0,0);
   fmass12->SetParameter(1,5.364986);
   fmass12->SetParError(1,0.002159327);
   fmass12->SetParLimits(1,0,0);
   fmass12->SetParameter(2,0.01348936);
   ...
   fmass12->SetParameter(7,0.7814687);
   fmass12->SetParError(7,0);
   fmass12->SetParLimits(7,0,0);
   fmass12->SetParameter(8,0.03894574);
   ...
   f13->SetParameter(0,1.470999);
   f13->SetParError(0,0.1899615);
   f13->SetParLimits(0,0,0);
   f13->SetParameter(1,5.364986);
   f13->SetParError(1,0.002159327);
   f13->SetParLimits(1,0,0);
   f13->SetParameter(2,0.01348936);
   f13->SetParError(2,0);
   f13->SetParLimits(2,0.01348936,0.01348936);
   f13->SetParameter(3,23.10204);
   f13->SetParError(3,0.2410518);
   f13->SetParLimits(3,0,0);
   f13->SetParameter(4,-3.620556);
   f13->SetParError(4,0.04269679);
   f13->SetParLimits(4,0,0);
   f13->SetParameter(5,-504578.2);
   f13->SetParError(5,2.4);
   f13->SetParLimits(5,0,0);
   f13->SetParameter(6,0);
   f13->SetParError(6,1);
   f13->SetParLimits(6,0,0);
   f13->SetParameter(7,0.7814687);
   f13->SetParError(7,0);
   f13->SetParLimits(7,0.7814687,0.7814687);
   f13->SetParameter(8,0.03894574);
   f13->SetParError(8,0);
   f13->SetParLimits(8,0.03894574,0.03894574);
   f13->Draw("same");
   
   TH1D *h1_copy2 = new TH1D("h1_copy2","",50,5,6);
   h1_copy2->SetBinContent(1,7);
   h1_copy2->SetBinContent(2,10);
   h1_copy2->SetBinContent(3,6);
   h1_copy2->SetBinContent(4,3);
   h1_copy2->SetBinContent(5,5);
   h1_copy2->SetBinContent(6,6);
   h1_copy2->SetBinContent(7,3);
   h1_copy2->SetBinContent(8,3);
   h1_copy2->SetBinContent(9,4);
   h1_copy2->SetBinContent(10,1);
   h1_copy2->SetBinContent(11,6);
   h1_copy2->SetBinContent(12,2);
   h1_copy2->SetBinContent(13,13);
   h1_copy2->SetBinContent(14,7);
   h1_copy2->SetBinContent(15,4);
   h1_copy2->SetBinContent(16,5);
   h1_copy2->SetBinContent(17,8);
   h1_copy2->SetBinContent(18,22);
   h1_copy2->SetBinContent(19,45);
   h1_copy2->SetBinContent(20,9);
   h1_copy2->SetBinContent(21,3);
   h1_copy2->SetBinContent(22,3);
   h1_copy2->SetBinContent(23,2);
   h1_copy2->SetBinContent(24,3);
   h1_copy2->SetBinContent(25,1);
   h1_copy2->SetBinContent(27,2);
   h1_copy2->SetBinContent(28,2);
   h1_copy2->SetBinContent(30,1);
   h1_copy2->SetBinContent(31,4);
   h1_copy2->SetBinContent(32,3);
   h1_copy2->SetBinContent(33,2);
   h1_copy2->SetBinContent(34,3);
   h1_copy2->SetBinContent(35,3);
   h1_copy2->SetBinContent(36,1);
   h1_copy2->SetBinContent(37,2);
   h1_copy2->SetBinContent(38,2);
   h1_copy2->SetBinContent(39,4);
   h1_copy2->SetBinContent(40,1);
   h1_copy2->SetBinContent(41,4);
   h1_copy2->SetBinContent(42,2);
   h1_copy2->SetBinContent(43,3);
   h1_copy2->SetBinContent(44,1);
   h1_copy2->SetBinContent(45,2);
   h1_copy2->SetBinContent(46,2);
   h1_copy2->SetBinContent(47,2);
   h1_copy2->SetBinContent(48,3);
   h1_copy2->SetBinContent(50,3);
   h1_copy2->SetMinimum(0);
   h1_copy2->SetMaximum(93.07477);
   h1_copy2->SetEntries(233);
   ...
   f11->SetParameter(0,1.470999);
   f11->SetParError(0,0.1899615);
   f11->SetParLimits(0,0,0);
   f11->SetParameter(1,5.364986);
   f11->SetParError(1,0.002159327);
   f11->SetParLimits(1,0,0);
   f11->SetParameter(2,0.01348936);
   f11->SetParError(2,0);
   f11->SetParLimits(2,0.01348936,0.01348936);
   f11->SetParameter(3,23.10204);
   f11->SetParError(3,0.2410518);
   f11->SetParLimits(3,0,0);
   f11->SetParameter(4,-3.620556);
   f11->SetParError(4,0.04269679);
   f11->SetParLimits(4,0,0);
   f11->SetParameter(5,-504578.2);
   f11->SetParError(5,2.4);
   f11->SetParLimits(5,0,0);
   f11->SetParameter(6,0);
   f11->SetParError(6,1);
   f11->SetParLimits(6,0,0);
   f11->SetParameter(7,0.7814687);
   f11->SetParError(7,0);
   f11->SetParLimits(7,0.7814687,0.7814687);
   f11->SetParameter(8,0.03894574);
   f11->SetParError(8,0);
   f11->SetParLimits(8,0.03894574,0.03894574);
...
tex->SetNDC();
   ...
   f12->SetParameter(0,1.470999);
   f12->SetParError(0,0.1899615);
   f12->SetParLimits(0,0,0);
   f12->SetParameter(1,5.364986);
   f12->SetParError(1,0.002159327);
   f12->SetParLimits(1,0,0);
   f12->SetParameter(2,0.01348936);
   f12->SetParError(2,0);
   f12->SetParLimits(2,0.01348936,0.01348936);
   f12->SetParameter(3,23.10204);
   f12->SetParError(3,0.2410518);
   f12->SetParLimits(3,0,0);
   f12->SetParameter(4,-3.620556);
   f12->SetParError(4,0.04269679);
   f12->SetParLimits(4,0,0);
   f12->SetParameter(5,-504578.2);
   ...
   f12->SetParError(7,0);
   f12->SetParLimits(7,0.7814687,0.7814687);
   f12->SetParameter(8,0.03894574);
   f12->SetParError(8,0);
   f12->SetParLimits(8,0.03894574,0.03894574);
   f12->Draw("same");
   
   TH1D *h13 = new TH1D("h13","",50,5,6);
   h13->SetBinContent(1,7);
   h13->SetBinContent(2,10);
   h13->SetBinContent(3,6);
   h13->SetBinContent(4,3);
   h13->SetBinContent(5,5);
   h13->SetBinContent(6,6);
   h13->SetBinContent(7,3);
   h13->SetBinContent(8,3);
   h13->SetBinContent(9,4);
   h13->SetBinContent(10,1);
   h13->SetBinContent(11,6);
   h13->SetBinContent(12,2);
   h13->SetBinContent(13,13);
   h13->SetBinContent(14,7);
   h13->SetBinContent(15,4);
   h13->SetBinContent(16,5);
   h13->SetBinContent(17,8);
   h13->SetBinContent(18,22);
   h13->SetBinContent(19,45);
   h13->SetBinContent(20,9);
   h13->SetBinContent(21,3);
   h13->SetBinContent(22,3);
   h13->SetBinContent(23,2);
   h13->SetBinContent(24,3);
   h13->SetBinContent(25,1);
   h13->SetBinContent(27,2);
   h13->SetBinContent(28,2);
   h13->SetBinContent(30,1);
   h13->SetBinContent(31,4);
   h13->SetBinContent(32,3);
   h13->SetBinContent(33,2);
   h13->SetBinContent(34,3);
   h13->SetBinContent(35,3);
   h13->SetBinContent(36,1);
   h13->SetBinContent(37,2);
   h13->SetBinContent(38,2);
   h13->SetBinContent(39,4);
   h13->SetBinContent(40,1);
   h13->SetBinContent(41,4);
   h13->SetBinContent(42,2);
   h13->SetBinContent(43,3);
   h13->SetBinContent(44,1);
   h13->SetBinContent(45,2);
   h13->SetBinContent(46,2);
   h13->SetBinContent(47,2);
   h13->SetBinContent(48,3);
   h13->SetBinContent(50,3);
   h13->SetMinimum(0);
   h13->SetMaximum(93.07477);
   h13->SetEntries(233);
   h13->SetStats(0);
   h13->SetLineWidth(4);
   ...
   h13->Draw("e same");
      tex = new TLatex(0.55,0.5,"#chi^{2}/nDOF: 60/44 = 1.4");
tex->SetNDC();
   tex->SetTextAlign(12);
   tex->SetTextFont(42);
