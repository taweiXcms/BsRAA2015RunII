...
//=========  (Fri Aug  3 02:58:38 2018) by ROOT version6.02/13
   ...
   c1->Range(4.76834,-2.501475,6.055341,14.75008);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   h11->SetBinContent(1,1);
   h11->SetBinContent(2,1);
   h11->SetBinContent(3,1);
   h11->SetBinContent(4,1);
   h11->SetBinContent(5,2);
   h11->SetBinContent(7,1);
   h11->SetBinContent(8,1);
   h11->SetBinContent(10,1);
   h11->SetBinContent(11,1);
   h11->SetBinContent(14,1);
   h11->SetBinContent(17,1);
   h11->SetBinContent(18,3);
   h11->SetBinContent(19,5);
   h11->SetBinContent(20,3);
   h11->SetBinContent(24,1);
   h11->SetBinContent(25,2);
   ...
   h11->SetBinContent(48,1);
   h11->SetBinContent(49,1);
   h11->SetBinContent(50,1);
   h11->SetMinimum(0);
   h11->SetMaximum(13.02492);
   h11->SetEntries(35);
   h11->SetStats(0);
   h11->SetLineWidth(4);
   ...
   background11->SetParameter(3,1.713646);
   background11->SetParError(3,0);
   background11->SetParLimits(3,0,0);
   background11->SetParameter(4,-0.2186022);
   ...
   fmass12->SetParameter(0,0.1884964);
   fmass12->SetParError(0,0.06802997);
   fmass12->SetParLimits(0,0,0);
   fmass12->SetParameter(1,5.369299);
   fmass12->SetParError(1,0.006239128);
   fmass12->SetParLimits(1,0,0);
   fmass12->SetParameter(2,0.01231959);
   ...
   fmass12->SetParameter(7,0.783449);
   fmass12->SetParError(7,0);
   fmass12->SetParLimits(7,0,0);
   fmass12->SetParameter(8,0.03207556);
   ...
   f13->SetParameter(0,0.1884964);
   f13->SetParError(0,0.06802997);
   f13->SetParLimits(0,0,0);
   f13->SetParameter(1,5.369299);
   f13->SetParError(1,0.006239128);
   f13->SetParLimits(1,0,0);
   f13->SetParameter(2,0.01231959);
   f13->SetParError(2,0);
   f13->SetParLimits(2,0.01231959,0.01231959);
   f13->SetParameter(3,1.713646);
   f13->SetParError(3,0.1031139);
   f13->SetParLimits(3,0,0);
   f13->SetParameter(4,-0.2186022);
   f13->SetParError(4,0.01849079);
   f13->SetParLimits(4,0,0);
   f13->SetParameter(5,-255582.8);
   f13->SetParError(5,2.4);
   f13->SetParLimits(5,0,0);
   f13->SetParameter(6,0);
   f13->SetParError(6,1);
   f13->SetParLimits(6,0,0);
   f13->SetParameter(7,0.783449);
   f13->SetParError(7,0);
   f13->SetParLimits(7,0.783449,0.783449);
   f13->SetParameter(8,0.03207556);
   f13->SetParError(8,0);
   f13->SetParLimits(8,0.03207556,0.03207556);
   f13->Draw("same");
   
   TH1D *h1_copy2 = new TH1D("h1_copy2","",50,5,6);
   h1_copy2->SetBinContent(1,1);
   h1_copy2->SetBinContent(2,1);
   h1_copy2->SetBinContent(3,1);
   h1_copy2->SetBinContent(4,1);
   h1_copy2->SetBinContent(5,2);
   h1_copy2->SetBinContent(7,1);
   h1_copy2->SetBinContent(8,1);
   h1_copy2->SetBinContent(10,1);
   h1_copy2->SetBinContent(11,1);
   h1_copy2->SetBinContent(14,1);
   h1_copy2->SetBinContent(17,1);
   h1_copy2->SetBinContent(18,3);
   h1_copy2->SetBinContent(19,5);
   h1_copy2->SetBinContent(20,3);
   h1_copy2->SetBinContent(24,1);
   h1_copy2->SetBinContent(25,2);
   ...
   h1_copy2->SetBinContent(48,1);
   h1_copy2->SetBinContent(49,1);
   h1_copy2->SetBinContent(50,1);
   h1_copy2->SetMinimum(0);
   h1_copy2->SetMaximum(13.02492);
   h1_copy2->SetEntries(35);
   ...
   f11->SetParameter(0,0.1884964);
   f11->SetParError(0,0.06802997);
   f11->SetParLimits(0,0,0);
   f11->SetParameter(1,5.369299);
   f11->SetParError(1,0.006239128);
   f11->SetParLimits(1,0,0);
   f11->SetParameter(2,0.01231959);
   f11->SetParError(2,0);
   f11->SetParLimits(2,0.01231959,0.01231959);
   f11->SetParameter(3,1.713646);
   f11->SetParError(3,0.1031139);
   f11->SetParLimits(3,0,0);
   f11->SetParameter(4,-0.2186022);
   f11->SetParError(4,0.01849079);
   f11->SetParLimits(4,0,0);
   f11->SetParameter(5,-255582.8);
   f11->SetParError(5,2.4);
   f11->SetParLimits(5,0,0);
   f11->SetParameter(6,0);
   f11->SetParError(6,1);
   f11->SetParLimits(6,0,0);
   f11->SetParameter(7,0.783449);
   f11->SetParError(7,0);
   f11->SetParLimits(7,0.783449,0.783449);
   f11->SetParameter(8,0.03207556);
   f11->SetParError(8,0);
   f11->SetParLimits(8,0.03207556,0.03207556);
...
tex->SetNDC();
   ...
   f12->SetParameter(0,0.1884964);
   f12->SetParError(0,0.06802997);
   f12->SetParLimits(0,0,0);
   f12->SetParameter(1,5.369299);
   f12->SetParError(1,0.006239128);
   f12->SetParLimits(1,0,0);
   f12->SetParameter(2,0.01231959);
   f12->SetParError(2,0);
   f12->SetParLimits(2,0.01231959,0.01231959);
   f12->SetParameter(3,1.713646);
   f12->SetParError(3,0.1031139);
   f12->SetParLimits(3,0,0);
   f12->SetParameter(4,-0.2186022);
   f12->SetParError(4,0.01849079);
   f12->SetParLimits(4,0,0);
   f12->SetParameter(5,-255582.8);
   ...
   f12->SetParError(7,0);
   f12->SetParLimits(7,0.783449,0.783449);
   f12->SetParameter(8,0.03207556);
   f12->SetParError(8,0);
   f12->SetParLimits(8,0.03207556,0.03207556);
   f12->Draw("same");
   
   TH1D *h13 = new TH1D("h13","",50,5,6);
   h13->SetBinContent(1,1);
   h13->SetBinContent(2,1);
   h13->SetBinContent(3,1);
   h13->SetBinContent(4,1);
   h13->SetBinContent(5,2);
   h13->SetBinContent(7,1);
   h13->SetBinContent(8,1);
   h13->SetBinContent(10,1);
   h13->SetBinContent(11,1);
   h13->SetBinContent(14,1);
   h13->SetBinContent(17,1);
   h13->SetBinContent(18,3);
   h13->SetBinContent(19,5);
   h13->SetBinContent(20,3);
   h13->SetBinContent(24,1);
   h13->SetBinContent(25,2);
   ...
   h13->SetBinContent(48,1);
   h13->SetBinContent(49,1);
   h13->SetBinContent(50,1);
   h13->SetMinimum(0);
   h13->SetMaximum(13.02492);
   h13->SetEntries(35);
   h13->SetStats(0);
   h13->SetLineWidth(4);
   ...
   h13->Draw("e same");
      tex = new TLatex(0.55,0.5,"#chi^{2}/nDOF: 38/44 = 0.87");
tex->SetNDC();
   tex->SetTextAlign(12);
   tex->SetTextFont(42);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.54,"Significance = 2.7");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.44,"Yield = 9.4");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
