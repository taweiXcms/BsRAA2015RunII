...
//=========  (Sat Sep 23 08:32:47 2017) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.04798814);
   hEff2->SetBinContent(2,0.1226761);
   hEff2->SetBinError(1,0.001206225);
   hEff2->SetBinError(2,0.06992587);
   hEff2->SetEntries(1582.746);
   hEff2->SetStats(0);
