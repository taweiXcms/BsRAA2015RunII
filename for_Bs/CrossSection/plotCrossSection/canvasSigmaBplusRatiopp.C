...
//=========  (Fri Oct  6 21:27:19 2017) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   pSigma->Draw();
   pSigma->cd();
   pSigma->Range(-11.78841,3,69.42065,7.37037);
   ...
   TH2F *hemptySigma1 = new TH2F("hemptySigma1","",50,0,65,10,1000,1e+07);
   ...
   TH1F *Graph_gaeSigmaBplus3001 = new TH1F("Graph_gaeSigmaBplus3001","",100,0,65.5);
   Graph_gaeSigmaBplus3001->SetMinimum(2555.73);
   Graph_gaeSigmaBplus3001->SetMaximum(1198659);
   ...
   hPtSigma2->SetBinContent(1,1023606);
   hPtSigma2->SetBinContent(2,197462.8);
   hPtSigma2->SetBinContent(3,34192);
   hPtSigma2->SetBinContent(4,2974.752);
   hPtSigma2->SetBinError(1,294798.3);
   hPtSigma2->SetBinError(2,27454.09);
   hPtSigma2->SetBinError(3,7530.346);
   hPtSigma2->SetBinError(4,531.8871);
   hPtSigma2->SetEntries(18.0485);
   ...
   TH1F *Graph_gaeCrossSyst3002 = new TH1F("Graph_gaeCrossSyst3002","Graph",100,0,65.5);
   Graph_gaeCrossSyst3002->SetMinimum(2677.277);
   Graph_gaeCrossSyst3002->SetMaximum(1125669);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.53,0.59,"Global uncert. 12.4%");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
   tex->Draw();
...
// ------------>Primitives in pad: pRatio
   ...
   pRatio->Draw();
   pRatio->cd();
   pRatio->Range(-11.78841,-0.4857143,69.42065,1.8);
   ...
   TH2F *hemptyRatio3 = new TH2F("hemptyRatio3","",50,0,65,10,0.2,1.8);
   ...
   TH1F *Graph_gaeRatioCrossFONLLunity3003 = new TH1F("Graph_gaeRatioCrossFONLLunity3003","Graph",100,0,65.5);
   Graph_gaeRatioCrossFONLLunity3003->SetMinimum(0.6718466);
   Graph_gaeRatioCrossFONLLunity3003->SetMaximum(1.472511);
   ...
   TH1F *Graph_gaeRatioCrossFONLLstat3004 = new TH1F("Graph_gaeRatioCrossFONLLstat3004","Graph",100,0,65.5);
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.4646278);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.812793);
   ...
   TH1F *Graph_gaeRatioCrossFONLLsyst3005 = new TH1F("Graph_gaeRatioCrossFONLLsyst3005","Graph",100,0,65.5);
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6819076);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.37825);
