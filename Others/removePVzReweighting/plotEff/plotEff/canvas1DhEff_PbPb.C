...
//=========  (Mon Mar  5 01:38:43 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0008806942);
   hEff2->SetBinContent(1,0.04748125);
   hEff2->SetBinContent(2,0.1453341);
   hEff2->SetBinError(0,4.953521e-05);
   hEff2->SetBinError(1,0.0009105249);
   hEff2->SetBinError(2,0.00430294);
   hEff2->SetEntries(2719.322);
   hEff2->SetStats(0);
