...
//=========  (Sun Mar 11 17:45:36 2018) by ROOT version6.02/13
   TCanvas *canvas1D = new TCanvas("canvas1D", "",0,0,600,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   canvas1D->SetHighLightColor(2);
   canvas1D->Range(4.375,-0.1,60.625,0.9);
   ...
   TH2F *hemptyEff1 = new TH2F("hemptyEff1","",50,10,55,10,0,0.8);
   ...
   hEff2->SetBinContent(0,0.005891809);
   hEff2->SetBinContent(1,0.1439083);
   hEff2->SetBinContent(2,9.376243e+97);
   hEff2->SetBinError(0,5.828752e-05);
   hEff2->SetBinError(1,0.0007216989);
   hEff2->SetBinError(2,1.425513e+147);
   hEff2->SetEntries(39761.19);
   hEff2->SetStats(0);
