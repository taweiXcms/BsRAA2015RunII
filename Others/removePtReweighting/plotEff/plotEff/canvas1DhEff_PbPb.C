...
//=========  (Sun Mar 11 17:47:31 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0007332742);
   hEff2->SetBinContent(1,0.04589725);
   hEff2->SetBinContent(2,0.142473);
   hEff2->SetBinError(0,4.611973e-05);
   hEff2->SetBinError(1,0.001023679);
   hEff2->SetBinError(2,0.004327978);
   hEff2->SetEntries(2010.229);
   hEff2->SetStats(0);
