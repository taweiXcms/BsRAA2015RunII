...
//=========  (Tue Mar  6 23:16:48 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.008817895);
   hEff2->SetBinContent(1,0.1517698);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,8.267977e-05);
   hEff2->SetBinError(1,0.0007277251);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(43494.66);
   hEff2->SetStats(0);
