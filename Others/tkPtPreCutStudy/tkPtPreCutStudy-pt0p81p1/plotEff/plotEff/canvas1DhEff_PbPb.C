...
//=========  (Wed Mar  7 02:24:58 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0006287863);
   hEff2->SetBinContent(1,0.04462895);
   hEff2->SetBinContent(2,0.1405347);
   hEff2->SetBinError(0,4.468878e-05);
   hEff2->SetBinError(1,0.0009984224);
   hEff2->SetBinError(2,0.00470404);
   hEff2->SetEntries(1998.042);
   hEff2->SetStats(0);
