...
//=========  (Wed Mar  7 02:25:00 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,5954.92);
   hPtSigma2->SetBinError(1,2202.843);
   hPtSigma2->SetEntries(7.307766);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(4843.044);
   Graph_gaeCrossSyst3001->SetMaximum(7066.796);
