...
//=========  (Tue Mar  6 23:16:51 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,9036.764);
   hPtSigma2->SetBinError(1,1135.531);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(63.33269);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7674.893);
   Graph_gaeCrossSyst3002->SetMaximum(10398.63);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.7309263);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(0.9904965);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7309993);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9904235);
