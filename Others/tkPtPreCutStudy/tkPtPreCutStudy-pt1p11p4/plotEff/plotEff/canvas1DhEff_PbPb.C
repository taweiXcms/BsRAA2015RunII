...
//=========  (Tue Mar  6 23:22:23 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0003613077);
   hEff2->SetBinContent(1,0.03528849);
   hEff2->SetBinContent(2,0.1311942);
   hEff2->SetBinError(0,3.58786e-05);
   hEff2->SetBinError(1,0.0008529875);
   hEff2->SetBinError(2,0.004593455);
   hEff2->SetEntries(1711.516);
   hEff2->SetStats(0);
