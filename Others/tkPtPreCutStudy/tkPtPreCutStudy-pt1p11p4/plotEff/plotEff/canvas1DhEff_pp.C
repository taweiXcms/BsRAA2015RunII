...
//=========  (Tue Mar  6 23:17:52 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.006404763);
   hEff2->SetBinContent(1,0.1355948);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,6.99589e-05);
   hEff2->SetBinError(1,0.0006891277);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(38715.66);
   hEff2->SetStats(0);
