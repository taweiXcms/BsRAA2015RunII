...
//=========  (Tue Mar  6 23:22:25 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,6759.25);
   hPtSigma2->SetBinError(1,211.992);
   hPtSigma2->SetEntries(1016.618);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(5495.012);
   Graph_gaeCrossSyst3001->SetMaximum(8023.489);
