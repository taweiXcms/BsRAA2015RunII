...
//=========  (Tue Mar  6 23:17:54 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,9223.389);
   hPtSigma2->SetBinError(1,1186.802);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(60.39822);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7833.268);
   Graph_gaeCrossSyst3002->SetMaximum(10613.51);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.7428414);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(1.014132);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7460838);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(1.010889);
