...
//=========  (Tue Mar  6 23:22:05 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,4540.598);
   hPtSigma2->SetBinError(1,1993.581);
   hPtSigma2->SetEntries(5.187505);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(3692.773);
   Graph_gaeCrossSyst3001->SetMaximum(5388.424);
