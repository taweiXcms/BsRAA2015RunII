...
//=========  (Tue Mar  6 23:17:31 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,9042.011);
   hPtSigma2->SetBinError(1,1163.132);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(60.43273);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7679.287);
   Graph_gaeCrossSyst3002->SetMaximum(10404.73);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.7282714);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(0.9941509);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7314178);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9910045);
