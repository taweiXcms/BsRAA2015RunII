...
//=========  (Tue Mar  6 23:17:28 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.007437021);
   hEff2->SetBinContent(1,0.143256);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,7.566658e-05);
   hEff2->SetBinError(1,0.0007079433);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(40947.64);
   hEff2->SetStats(0);
