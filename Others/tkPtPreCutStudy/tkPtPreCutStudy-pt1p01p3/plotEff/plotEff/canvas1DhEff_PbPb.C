...
//=========  (Tue Mar  6 23:22:03 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0005473573);
   hEff2->SetBinContent(1,0.04272192);
   hEff2->SetBinContent(2,0.1404842);
   hEff2->SetBinError(0,4.405067e-05);
   hEff2->SetBinError(1,0.0009571492);
   hEff2->SetBinError(2,0.004703647);
   hEff2->SetEntries(1992.243);
   hEff2->SetStats(0);
