...
//=========  (Tue Mar  6 23:17:10 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.007450235);
   hEff2->SetBinContent(1,0.1420845);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,7.57734e-05);
   hEff2->SetBinError(1,0.0007056607);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(40541.66);
   hEff2->SetStats(0);
