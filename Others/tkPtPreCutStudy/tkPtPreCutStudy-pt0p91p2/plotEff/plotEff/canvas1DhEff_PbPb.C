...
//=========  (Tue Mar  6 23:21:46 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0009359921);
   hEff2->SetBinContent(1,0.05033946);
   hEff2->SetBinContent(2,0.1462825);
   hEff2->SetBinError(0,5.963992e-05);
   hEff2->SetBinError(1,0.001047007);
   hEff2->SetBinError(2,0.004785936);
   hEff2->SetEntries(2311.628);
   hEff2->SetStats(0);
