...
//=========  (Tue Mar  6 23:21:48 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,5558.32);
   hPtSigma2->SetBinError(1,2093.853);
   hPtSigma2->SetEntries(7.046846);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(4521.951);
   Graph_gaeCrossSyst3001->SetMaximum(6594.688);
