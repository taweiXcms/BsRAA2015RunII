...
//=========  (Tue Mar  6 23:17:13 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,8968.541);
   hPtSigma2->SetBinError(1,1145.708);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(61.27676);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7616.879);
   Graph_gaeCrossSyst3002->SetMaximum(10320.2);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.7232652);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(0.9851617);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7254737);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9829532);
