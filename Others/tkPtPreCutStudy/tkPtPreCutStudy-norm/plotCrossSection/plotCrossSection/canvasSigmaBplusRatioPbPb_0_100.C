...
//=========  (Tue Mar  6 01:44:02 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,4625.639);
   hPtSigma2->SetBinError(1,1911.87);
   hPtSigma2->SetEntries(5.853651);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(3762.679);
   Graph_gaeCrossSyst3001->SetMaximum(5488.599);
