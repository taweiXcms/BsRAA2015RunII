...
//=========  (Tue Mar  6 01:41:52 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,8668.306);
   hPtSigma2->SetBinError(1,1097.878);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(62.33901);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7361.915);
   Graph_gaeCrossSyst3002->SetMaximum(9974.696);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.7001358);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(0.951099);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7011895);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9500453);
