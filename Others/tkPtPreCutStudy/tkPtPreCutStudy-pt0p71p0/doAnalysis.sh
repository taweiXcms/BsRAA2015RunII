...
INPUTMCPPBDT="/export/d00/scratch/tawei/HeavyFlavor/Run2Ana/BsTMVA/TMVA_Bs-20180304-d4-1550-nominal-tkpt/pt0p71p0/tmvaVal/MVAfiles/BDT_pp_15_50_varStage1_MC.root"
...
INPUTDATAPPBDT="/export/d00/scratch/tawei/HeavyFlavor/Run2Ana/BsTMVA/TMVA_Bs-20180304-d4-1550-nominal-tkpt/pt0p71p0/tmvaVal/MVAfiles/BDT_pp_15_50_varStage1_DATA.root"
...
INPUTMCPbPbBDT="/export/d00/scratch/tawei/HeavyFlavor/Run2Ana/BsTMVA/TMVA_Bs-20180304-d4-1550-nominal-tkpt/pt0p71p0/tmvaVal/MVAfiles/BDT_PbPb_15_50_varStage1_MC.root"
...
INPUTDATAPbPbBDT="/export/d00/scratch/tawei/HeavyFlavor/Run2Ana/BsTMVA/TMVA_Bs-20180304-d4-1550-nominal-tkpt/pt0p71p0/tmvaVal/MVAfiles/BDT_PbPb_15_50_varStage1_DATA.root"
...
SELGENPbPbACCPbPb="TMath::Abs(Gy)<2.4&&abs(GpdgId)==531&&GisSignal>0&&((TMath::Abs(Gmu1eta)<1.2&&Gmu1pt>3.5)||(TMath::Abs(Gmu1eta)>1.2&&TMath::Abs(Gmu1eta)<2.1&&Gmu1pt>(5.77-1.8*TMath::Abs(Gmu1eta)))||(TMath::Abs(Gmu1eta)>2.1&&TMath::Abs(Gmu1eta)<2.4&&Gmu1pt>1.8))&&((TMath::Abs(Gmu2eta)<1.2&&Gmu2pt>3.5)||(TMath::Abs(Gmu2eta)>1.2&&TMath::Abs(Gmu2eta)<2.1&&Gmu2pt>(5.77-1.8*TMath::Abs(Gmu2eta)))||(TMath::Abs(Gmu2eta)>2.1&&TMath::Abs(Gmu2eta)<2.4&&Gmu2pt>1.8))&&Gtk1pt>1.0&&Gtk2pt>1.0&&TMath::Abs(Gtk1eta)<2.4&&TMath::Abs(Gtk2eta)<2.4"
...
CUTPbPb=${BASECUTPbPb}"&&BDTStage1_pt15to50>0.256617"
