...
//=========  (Tue Mar  6 23:16:28 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,8638.637);
   hPtSigma2->SetBinError(1,1123.785);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(59.09134);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7336.703);
   Graph_gaeCrossSyst3002->SetMaximum(9940.571);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.694349);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(0.9512342);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.6987882);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.946795);
