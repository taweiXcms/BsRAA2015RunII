...
//=========  (Tue Mar  6 23:16:25 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.008369458);
   hEff2->SetBinContent(1,0.1434736);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,8.054379e-05);
   hEff2->SetBinError(1,0.0007100692);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(40826.53);
   hEff2->SetStats(0);
