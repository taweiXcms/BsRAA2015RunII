...
//=========  (Wed Mar  7 02:25:04 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0007806625);
   hEff2->SetBinContent(1,0.04757459);
   hEff2->SetBinContent(2,0.1426844);
   hEff2->SetBinError(0,4.913986e-05);
   hEff2->SetBinError(1,0.001020309);
   hEff2->SetBinError(2,0.004722745);
   hEff2->SetEntries(2174.137);
   hEff2->SetStats(0);
