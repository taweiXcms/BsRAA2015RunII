...
//=========  (Tue Mar  6 23:15:50 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.008549516);
   hEff2->SetBinContent(1,0.146637);
   hEff2->SetBinContent(2,6.77238e-77);
   hEff2->SetBinError(0,8.145074e-05);
   hEff2->SetBinError(1,0.0007177817);
   hEff2->SetBinError(2,nan);
   hEff2->SetEntries(41735.19);
   hEff2->SetStats(0);
