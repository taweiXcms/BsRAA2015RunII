...
//=========  (Tue Mar  6 23:20:35 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001130524);
   hEff2->SetBinContent(1,0.05190844);
   hEff2->SetBinContent(2,0.1461497);
   hEff2->SetBinError(0,6.688751e-05);
   hEff2->SetBinError(1,0.001077623);
   hEff2->SetBinError(2,0.004759486);
   hEff2->SetEntries(2320.29);
   hEff2->SetStats(0);
