...
//=========  (Tue Mar  6 23:20:37 2018) by ROOT version6.02/13
   ...
   hPtSigma2->SetBinContent(1,4774.264);
   hPtSigma2->SetBinError(1,1919.079);
   hPtSigma2->SetEntries(6.189093);
   ...
   Graph_gaeCrossSyst3001->SetMinimum(3884.115);
   Graph_gaeCrossSyst3001->SetMaximum(5664.412);
