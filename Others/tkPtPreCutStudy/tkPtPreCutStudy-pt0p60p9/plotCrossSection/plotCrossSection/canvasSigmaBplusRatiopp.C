...
//=========  (Tue Mar  6 23:15:53 2018) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   hPtSigma2->SetBinContent(1,8880.85);
   hPtSigma2->SetBinError(1,1110.305);
   hPtSigma2->SetBinError(2,nan);
   hPtSigma2->SetEntries(63.97704);
   ...
   Graph_gaeCrossSyst3002->SetMinimum(7542.434);
   Graph_gaeCrossSyst3002->SetMaximum(10219.26);
...
// ------------>Primitives in pad: pRatio
   ...
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0.7189593);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(0.9727632);
   ...
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0.7183832);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(0.9733393);
