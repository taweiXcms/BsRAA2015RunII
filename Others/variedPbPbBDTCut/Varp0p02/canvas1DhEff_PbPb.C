...
//=========  (Sat Apr 14 23:20:37 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001005458);
   hEff2->SetBinContent(1,0.0464996);
   hEff2->SetBinContent(2,0.1359788);
   hEff2->SetBinError(0,5.951512e-05);
   hEff2->SetBinError(1,0.001024267);
   hEff2->SetBinError(2,0.004349711);
   hEff2->SetEntries(2060.973);
   hEff2->SetStats(0);
