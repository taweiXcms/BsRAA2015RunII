...
//=========  (Sat Apr 14 23:32:52 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001549333);
   hEff2->SetBinContent(1,0.05510957);
   hEff2->SetBinContent(2,0.14781);
   hEff2->SetBinError(0,7.787977e-05);
   hEff2->SetBinError(1,0.001115478);
   hEff2->SetBinError(2,0.00469164);
   hEff2->SetEntries(2440.798);
   hEff2->SetStats(0);
