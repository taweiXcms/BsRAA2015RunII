...
//=========  (Sun Apr 15 03:54:48 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.00206451);
   hEff2->SetBinContent(1,0.06225716);
   hEff2->SetBinContent(2,0.1528493);
   hEff2->SetBinError(0,9.160763e-05);
   hEff2->SetBinError(1,0.001193371);
   hEff2->SetBinError(2,0.004771249);
   hEff2->SetEntries(2721.622);
   hEff2->SetStats(0);
