...
//=========  (Sun Apr 15 02:57:28 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001955189);
   hEff2->SetBinContent(1,0.06106475);
   hEff2->SetBinContent(2,0.1522799);
   hEff2->SetBinError(0,8.803162e-05);
   hEff2->SetBinError(1,0.001185047);
   hEff2->SetBinError(2,0.004765547);
   hEff2->SetEntries(2655.278);
   hEff2->SetStats(0);
