...
//=========  (Sat Apr 14 22:51:59 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001108356);
   hEff2->SetBinContent(1,0.04833505);
   hEff2->SetBinContent(2,0.1391384);
   hEff2->SetBinError(0,6.253807e-05);
   hEff2->SetBinError(1,0.001038761);
   hEff2->SetBinError(2,0.004464744);
   hEff2->SetEntries(2165.174);
   hEff2->SetStats(0);
