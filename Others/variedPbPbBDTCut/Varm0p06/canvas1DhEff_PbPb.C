...
//=========  (Sun Apr 15 02:57:26 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001858465);
   hEff2->SetBinContent(1,0.05971112);
   hEff2->SetBinContent(2,0.1510722);
   hEff2->SetBinError(0,8.648861e-05);
   hEff2->SetBinError(1,0.001170534);
   hEff2->SetBinError(2,0.00474514);
   hEff2->SetEntries(2602.212);
   hEff2->SetStats(0);
