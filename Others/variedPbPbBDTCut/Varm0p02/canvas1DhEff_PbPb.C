...
//=========  (Sat Apr 14 23:32:42 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001428796);
   hEff2->SetBinContent(1,0.05347864);
   hEff2->SetBinContent(2,0.1459574);
   hEff2->SetBinError(0,7.370736e-05);
   hEff2->SetBinError(1,0.001101894);
   hEff2->SetBinError(2,0.004662703);
   hEff2->SetEntries(2355.49);
   hEff2->SetStats(0);
