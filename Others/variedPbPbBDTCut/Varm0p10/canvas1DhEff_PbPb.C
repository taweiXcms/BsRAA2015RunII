...
//=========  (Sun Apr 15 03:59:39 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.002316543);
   hEff2->SetBinContent(1,0.06501581);
   hEff2->SetBinContent(2,0.1538448);
   hEff2->SetBinError(0,9.986155e-05);
   hEff2->SetBinError(1,0.00122322);
   hEff2->SetBinError(2,0.004778835);
   hEff2->SetEntries(2825.069);
   hEff2->SetStats(0);
