...
//=========  (Sat Apr 14 23:51:25 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0006960464);
   hEff2->SetBinContent(1,0.04022603);
   hEff2->SetBinContent(2,0.128678);
   hEff2->SetBinError(0,4.756826e-05);
   hEff2->SetBinError(1,0.0009514974);
   hEff2->SetBinError(2,0.004239697);
   hEff2->SetEntries(1787.307);
   hEff2->SetStats(0);
