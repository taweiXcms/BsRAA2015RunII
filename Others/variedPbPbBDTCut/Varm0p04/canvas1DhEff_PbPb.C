...
//=========  (Sun Apr 15 00:00:20 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001661754);
   hEff2->SetBinContent(1,0.05676613);
   hEff2->SetBinContent(2,0.1483294);
   hEff2->SetBinError(0,8.057057e-05);
   hEff2->SetBinError(1,0.001139256);
   hEff2->SetBinError(2,0.004695428);
   hEff2->SetEntries(2482.768);
   hEff2->SetStats(0);
