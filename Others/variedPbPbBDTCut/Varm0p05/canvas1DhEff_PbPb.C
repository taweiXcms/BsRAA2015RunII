...
//=========  (Sun Apr 15 00:04:57 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001770183);
   hEff2->SetBinContent(1,0.05817288);
   hEff2->SetBinContent(2,0.1497498);
   hEff2->SetBinError(0,8.494139e-05);
   hEff2->SetBinError(1,0.001152298);
   hEff2->SetBinError(2,0.004727771);
   hEff2->SetEntries(2548.657);
   hEff2->SetStats(0);
