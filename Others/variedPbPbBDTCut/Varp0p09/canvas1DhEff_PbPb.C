...
//=========  (Sun Apr 15 03:42:55 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0004203032);
   hEff2->SetBinContent(1,0.03031649);
   hEff2->SetBinContent(2,0.1078512);
   hEff2->SetBinError(0,3.821977e-05);
   hEff2->SetBinError(1,0.0008240763);
   hEff2->SetBinError(2,0.003966336);
   hEff2->SetEntries(1353.39);
   hEff2->SetStats(0);
