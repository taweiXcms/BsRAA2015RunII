...
//=========  (Sun Apr 15 02:44:05 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0006092118);
   hEff2->SetBinContent(1,0.0381234);
   hEff2->SetBinContent(2,0.1252636);
   hEff2->SetBinError(0,4.418242e-05);
   hEff2->SetBinError(1,0.0009317215);
   hEff2->SetBinError(2,0.004207477);
   hEff2->SetEntries(1674.214);
   hEff2->SetStats(0);
