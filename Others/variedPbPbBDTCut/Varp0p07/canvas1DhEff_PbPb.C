...
//=========  (Sun Apr 15 02:44:13 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0005519026);
   hEff2->SetBinContent(1,0.03580441);
   hEff2->SetBinContent(2,0.1205475);
   hEff2->SetBinError(0,4.236106e-05);
   hEff2->SetBinError(1,0.0009105047);
   hEff2->SetBinError(2,0.004155061);
   hEff2->SetEntries(1546.353);
   hEff2->SetStats(0);
