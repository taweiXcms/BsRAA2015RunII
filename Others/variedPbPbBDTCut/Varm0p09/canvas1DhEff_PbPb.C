...
//=========  (Sun Apr 15 03:57:57 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.002189795);
   hEff2->SetBinContent(1,0.06360154);
   hEff2->SetBinContent(2,0.1535262);
   hEff2->SetBinError(0,9.597422e-05);
   hEff2->SetBinError(1,0.001205215);
   hEff2->SetBinError(2,0.004776547);
   hEff2->SetEntries(2784.877);
   hEff2->SetStats(0);
