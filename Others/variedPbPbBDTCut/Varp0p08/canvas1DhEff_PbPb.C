...
//=========  (Sun Apr 15 03:40:29 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0004787342);
   hEff2->SetBinContent(1,0.03308436);
   hEff2->SetBinContent(2,0.1141718);
   hEff2->SetBinError(0,3.971186e-05);
   hEff2->SetBinError(1,0.0008793854);
   hEff2->SetBinError(2,0.004047482);
   hEff2->SetEntries(1415.425);
   hEff2->SetStats(0);
