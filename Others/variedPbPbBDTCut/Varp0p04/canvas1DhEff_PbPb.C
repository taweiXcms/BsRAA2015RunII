...
//=========  (Sat Apr 14 23:47:28 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0007937579);
   hEff2->SetBinContent(1,0.04211543);
   hEff2->SetBinContent(2,0.1322574);
   hEff2->SetBinError(0,5.09769e-05);
   hEff2->SetBinError(1,0.0009652857);
   hEff2->SetBinError(2,0.00429951);
   hEff2->SetEntries(1903.578);
   hEff2->SetStats(0);
