...
//=========  (Sat Apr 14 21:51:03 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001181973);
   hEff2->SetBinContent(1,0.05014478);
   hEff2->SetBinContent(2,0.1401323);
   hEff2->SetBinError(0,6.417167e-05);
   hEff2->SetBinError(1,0.001067179);
   hEff2->SetBinError(2,0.00447201);
   hEff2->SetEntries(2207.886);
   hEff2->SetStats(0);
