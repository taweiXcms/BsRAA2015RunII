...
//=========  (Sun Apr 15 03:45:09 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.000354847);
   hEff2->SetBinContent(1,0.02763034);
   hEff2->SetBinContent(2,0.1013803);
   hEff2->SetBinError(0,3.418612e-05);
   hEff2->SetBinError(1,0.0007948087);
   hEff2->SetBinError(2,0.003837369);
   hEff2->SetEntries(1208.501);
   hEff2->SetStats(0);
