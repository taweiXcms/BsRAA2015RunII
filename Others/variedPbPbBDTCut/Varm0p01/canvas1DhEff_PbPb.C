...
//=========  (Sat Apr 14 23:04:35 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.001317151);
   hEff2->SetBinContent(1,0.05197756);
   hEff2->SetBinContent(2,0.1419551);
   hEff2->SetBinError(0,6.857273e-05);
   hEff2->SetBinError(1,0.001086037);
   hEff2->SetBinError(2,0.004491986);
   hEff2->SetEntries(2290.564);
   hEff2->SetStats(0);
