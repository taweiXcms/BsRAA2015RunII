...
//=========  (Sat Apr 14 23:20:56 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0009119205);
   hEff2->SetBinContent(1,0.04440344);
   hEff2->SetBinContent(2,0.1346079);
   hEff2->SetBinError(0,5.501257e-05);
   hEff2->SetBinError(1,0.0009882919);
   hEff2->SetBinError(2,0.004319801);
   hEff2->SetEntries(2018.658);
   hEff2->SetStats(0);
