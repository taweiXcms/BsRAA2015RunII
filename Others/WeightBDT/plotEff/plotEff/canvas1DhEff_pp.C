...
//=========  (Tue Mar  6 17:16:54 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.0607571);
   hEff2->SetBinContent(1,0.5708968);
   hEff2->SetBinContent(2,1);
   hEff2->SetBinError(0,0.0009995885);
   hEff2->SetBinError(1,0.006175024);
   hEff2->SetEntries(8547.478);
   hEff2->SetStats(0);
