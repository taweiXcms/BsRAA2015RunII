...
//=========  (Tue Mar  6 17:18:36 2018) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(0,0.00734504);
   hEff2->SetBinContent(1,0.08973581);
   hEff2->SetBinContent(2,0.2672384);
   hEff2->SetBinError(0,0.000474103);
   hEff2->SetBinError(1,0.002144431);
   hEff2->SetBinError(2,0.01054269);
   hEff2->SetEntries(1751.087);
   hEff2->SetStats(0);
