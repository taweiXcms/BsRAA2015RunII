...
//		weighpthat = "pthatweight";
		weighpthat = "pthatweight*((4.91332e+00)+(-2.47954e+01)*BDTStage1_pt15to50+(3.59249e+01)*BDTStage1_pt15to50*BDTStage1_pt15to50)";
	...
	if(PbPbweight==1) {
//		weighpthat = "pthatweight";
		weighpthat = "pthatweight*((1.78294e+00)+(-6.84582e+00)*BDTStage1_pt15to50+(1.29939e+01)*BDTStage1_pt15to50*BDTStage1_pt15to50)";
