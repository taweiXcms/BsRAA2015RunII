...
void calRatio(TString inputSname="", TString inputBname="", Int_t pbpb=0, TString mva="BDT", Float_t ptMin=5., Float_t ptMax=7., Float_t RAA=1., TString predfname="pp_pT_5_7.h")
{
	...
	yieldDzero*=BR*deltapt*lumi*RAA*2*0.103;// need to consider HLT prescale
	Double_t genDzero = hfonll->Integral();
	genDzero*=BR*deltapt*lumi*RAA*2*0.103;// need to consider HLT prescale
	...
	cout<<"# of generated signal: "<<genDzero<<endl;
